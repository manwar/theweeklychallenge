...
#### 1. Abigail (1019)
    Awk (99), Bash (84), Basic (10), Bc (35), Befunge (23), Brainfuck (1), C (101), C Shell (8), COBOL (7), Chef (1), Erlang (8), Forth (7), Fortran (9), Go (38), Java (35), Lua (86), M4 (3), MMIX (3), Macro Processor (4), Mumps (1), Node.js (105), OCaml (6), Ook (1), PHP (7), Pascal (38), Postscript (5), Python (90), R (33), Rexx (6), Ruby (84), SQL (11), Scheme (32), Sed (5), Tcl (33).
#### 2. Paulo Custodio (496)
    Ada (19), Adb (1), Awk (27), Basic (43), Bc (16), Brainfuck (4), C (57), C++ (56), D (13), Forth (41), Fortran (7), Lua (37), Pascal (5), Python (170).
#### 3. Stuart Little (436)
...
#### 12. Cheok-Yin Fung (50)
    Awk (2), Bash (5), Befunge (1), Java (12), JavaScript (1), Julia (6), Lisp (11), Node.js (1), Python (3), Smalltalk (8).
#### 13. Mohammad Meraj Zia (49)
    Java (41), Kotlin (8).
#### 14. Eric Cheung (46)
    Excel VBA (43), Python (3).
#### 15. Nuno Vieira (44)
    JavaScript (44).
#### 16. Conor Hoekstra (40)
    APL (22), BQN (8), C++ (1), Haskell (4), J (5).
#### 17. Walt Mankowski (36)
    C (6), C++ (4), Python (26).
#### 18. Mohammad S Anwar (35)
...
#### 61. Tejas (2)
    C++ (2).
#### 62. Alexander Pankoff (1)
    Haskell (1).
#### 63. Bob Lied (1)
    C (1).
#### 64. Christian Jaeger (1)
    Haskell (1).
#### 65. Darren Bottin (1)
    Prolog (1).
#### 66. David Schwartz (1)
