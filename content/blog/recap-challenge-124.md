...
#### 1. Abigail (706)
    Awk (71), Bash (62), Basic (9), Bc (18), Befunge (22), Brainfuck (1), C (75), C Shell (7), COBOL (7), Chef (1), Erlang (6), Forth (7), Fortran (9), Go (17), Java (16), Lua (61), M4 (2), MMIX (3), Macro Processor (4), Mumps (1), Node.js (80), OCaml (6), Ook (1), PHP (6), Pascal (19), Postscript (5), Python (66), R (16), Rexx (6), Ruby (61), SQL (11), Scheme (13), Sed (5), Tcl (12).
#### 2. Stuart Little (404)
    Haskell (248), Lua (80), Node.js (36), Python (40).
#### 3. Paulo Custodio (349)
    Ada (19), Awk (25), Basic (41), Bc (14), Brainfuck (1), C (55), C++ (55), D (12), Forth (39), Fortran (6), Lua (35), Pascal (4), Python (43).
#### 4. Roger Bell_West (265)
    Bash (1), Postscript (8), Python (97), Ruby (85), Rust (74).
#### 5. Ulrich Rieke (150)
    Awk (1), C (2), C++ (64), Haskell (76), Java (1), Lisp (6).
#### 6. Laurent Rosenfeld (137)
    Awk (8), Bash (1), Bc (1), Bourne Shell (1), C (8), C++ (1), D (7), Dart (2), Gembase (3), Go (5), IO (1), Java (2), Julia (7), Kotlin (3), Lua (3), Nim (2), Pascal (4), Python (24), Ruby (8), Rust (6), Scala (36), Sed (1), Tcl (1), Visual Basic (1), Zig (1).
#### 7. Tyler Wardhaugh (136)
...
#### 12. Nuno Vieira (44)
    JavaScript (44).
#### 13. Mohammad Meraj Zia (40)
    Java (32), Kotlin (8).
#### 14. Cheok-Yin Fung (38)
...
#### 47. Gabor Szabo (3)
    Crystal (3).
#### 48. Guillermo Ramos (3)
    Go (3).
#### 49. Rage311 (3)
    Rust (3).
#### 50. Bartosz Jarzyna (2)
    PHP (2).
#### 51. Ben Davies (2)
    Idris (2).
#### 52. Daniel Mita (2)
...
***
    ...
    Python (490), Haskell (368), Lua (218), Ruby (166), C (153), C++ (152), Node.js (127), Awk (115), Rust (100), Clojure (88), Bash (74), APL (66), Java (64), Basic (50), Scala (50), JavaScript (49), Prolog (49), Go (48), Forth (46), Lisp (40), Bc (33), Pascal (28), R (28), Tcl (24), Befunge (22), D (20), PHP (20), Ada (19), Swift (18), Fortran (17), Postscript (16), Elm (15), Kotlin (14), OCaml (14), Scheme (13), Excel VBA (12), SQL (11), Erlang (8), Julia (8), Smalltalk (8), C Shell (7), COBOL (7), Rexx (6), Sed (6), Macro Processor (4), Nim (4), CESIL (3), Crystal (3), Dart (3), Gembase (3), Janet (3), MMIX (3), Zig (3), Brainfuck (2), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), M4 (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), BQN (1), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), Visual Basic (1), XSLT (1).
