...
#### 1. Abigail (409)
    Awk (42), Bash (33), Basic (7), Bc (10), Befunge (14), Brainfuck (1), C (47), C Shell (5), COBOL (5), Chef (1), Erlang (4), Forth (5), Fortran (7), Go (5), Java (4), Lua (34), Macro Processor (4), Mumps (1), Node.js (53), OCaml (4), Ook (1), PHP (4), Pascal (8), Postscript (3), Python (38), R (6), Rexx (4), Ruby (36), SQL (9), Scheme (6), Sed (4), Tcl (4).
#### 2. Stuart Little (240)
    Haskell (220), Node.js (8), Python (12).
#### 3. Paulo Custodio (224)
    Ada (14), Awk (20), Basic (36), Bc (2), C (26), C++ (26), Forth (34), Lua (30), Python (36).
#### 4. Roger Bell_West (180)
    Bash (1), Postscript (2), Python (71), Ruby (59), Rust (47).
#### 5. Ulrich Rieke (121)
    Awk (1), C++ (53), Haskell (63), Java (1), Lisp (3).
#### 6. Tyler Wardhaugh (120)
    Clojure (72), Lua (36), Python (12).
#### 7. Laurent Rosenfeld (107)
...
#### 15. Mohammad Meraj Zia (30)
    Java (22), Kotlin (8).
#### 16. Cheok-Yin Fung (28)
...
***
    ...
    Python (378), Haskell (326), Ruby (114), C++ (110), Lua (103), C (90), Awk (75), Clojure (72), Node.js (70), Rust (70), APL (58), JavaScript (48), Basic (43), Bash (39), Forth (39), Scala (39), Java (38), Lisp (37), Prolog (36), Go (33), R (18), Swift (18), PHP (15), Tcl (15), Ada (14), Befunge (14), Elm (14), Bc (13), Kotlin (13), OCaml (12), Pascal (12), Fortran (9), SQL (9), Julia (8), Postscript (8), Smalltalk (8), D (6), Erlang (6), Scheme (6), C Shell (5), COBOL (5), Macro Processor (4), Nim (4), Rexx (4), Sed (4), Gembase (3), Janet (3), Dart (2), HTML (2), Haxe (2), Idris (2), BQN (1), Brainfuck (1), C# (1), Chef (1), Fish (1), GNAT (1), Mumps (1), Ook (1), Visual Basic (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1152), Jaldhar H. Vyas (942), Roger Bell_West (868), Arne Sommer (798), Colin Crain (688), Athanasius (624), Adam Russell (550), E. Choroba (524), Stuart Little (500), Dave Jacoby (472), Javier Luque (460), Ulrich Rieke (458), Ruben Westerberg (452), Mohammad S Anwar (432), Simon Proctor (402), Duncan C. White (390), Luca Ferrari (388), Joelle Maslak (334), Abigail (308), Cheok-Yin Fung (300), Ryan Thompson (286), Mark Anderson (282), Flavio Poletti (270), Wanderdoc (266), Lubos Kolouch (256), Andrezgz (230), Simon Green (230), Paulo Custodio (228), Yet Ebreo (226), James Smith (216), Jorg Sommrey (208), Feng Chang (202), Myoungjin Jeon (192), Markus Holzer (190), Noud Aldenhoven (188), Niels van Dijke (186), Pete Houston (184), Kevin Colyer (176), Kian-Meng Ang (162), Steven Wilson (162), Walt Mankowski (162), Andrew Shitov (160), Duane Powell (148), Jan Krnavek (146), Shahed Nooshmand (140), Aaron Smith (136), Luis Mochan (120), Kang-min Liu (118), Julio de Castro (116), Gustavo Chaves (112), Saif Ahmed (110), Burkhard Nickels (108), Alicia Bielsa (106), Dave Cross (104), Nuno Vieira (104), Cristina Heredia (100)
