...
#### 1. Abigail (1027)
    Awk (99), Bash (85), Basic (10), Bc (36), Befunge (23), Brainfuck (1), C (101), C Shell (8), COBOL (7), Chef (1), Erlang (8), Forth (7), Fortran (9), Go (38), Java (35), Lua (87), M4 (3), MMIX (3), Macro Processor (4), Mumps (1), Node.js (106), OCaml (6), Ook (1), PHP (7), Pascal (38), Postscript (5), Python (91), R (34), Rexx (6), Ruby (85), SQL (11), Scheme (32), Sed (5), Tcl (34).
#### 2. Paulo Custodio (530)
    Ada (20), Adb (1), Awk (28), Basic (44), Bc (17), Brainfuck (5), C (58), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (192).
#### 3. Stuart Little (436)
...
#### 14. Mohammad Meraj Zia (49)
    Java (41), Kotlin (8).
#### 15. Conor Hoekstra (44)
    APL (26), BQN (8), C++ (1), Haskell (4), J (5).
#### 16. Nuno Vieira (44)
    JavaScript (44).
#### 17. Mohammad S Anwar (36)
