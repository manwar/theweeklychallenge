...
#### 3. Paulo Custodio (733)
    Ada (20), Adb (1), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (127), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (230).
#### 4. Ulrich Rieke (486)
...
#### 8. AhmetEmre (252)
    BQN (252).
#### 9. Lubos Kolouch (241)
    Bash (6), C++ (1), Go (2), Java (5), JavaScript (1), PHP (9), Python (215), Ruby (1), VBA (1).
...
#### 18. Duncan C. White (102)
    C (93), Pascal (6), Postscript (3).
