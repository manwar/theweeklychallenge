...
#### 3. Paulo Custodio (875)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (137), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (552)
    Awk (3), C (2), C++ (208), Haskell (243), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (77).
#### 5. Lubos Kolouch (489)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (423), Ruby (1), VBA (1).
#### 6. Stuart Little (436)
...
#### 77. Andinus (3)
    C (3).
#### 78. Andrii Mishchenko (3)
    Ruby (3).
#### 79. Gabor Szabo (3)
    Crystal (3).
#### 80. Guillermo Ramos (3)
    Go (3).
#### 81. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 82. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 83. Rage311 (3)
    Rust (3).
#### 84. Carlos Oliveira (2)
    C (2).
#### 85. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 86. Humberto Massa (2)
    C++ (2).
#### 87. Kjetil Skotheim (2)
    Scala (2).
#### 88. Mark Anderson (2)
    PowerShell (2).
#### 89. Mark Senn (2)
...
***
    ...
    Laurent Rosenfeld (2270), Jaldhar H. Vyas (2130), Roger Bell_West (2032), Luca Ferrari (1740), Flavio Poletti (1668), Arne Sommer (1666), Athanasius (1398), Colin Crain (1336), Ulrich Rieke (1258), Adam Russell (1084), Dave Jacoby (1022), E. Choroba (1004), Lubos Kolouch (938), Paulo Custodio (912), James Smith (860), Jorg Sommrey (860), W. Luis Mochan (832), Duncan C. White (794), Simon Green (756), Cheok-Yin Fung (720), Mohammad Sajid Anwar (718), Mark Anderson (712), Stuart Little (644), Abigail (574), Peter Campbell Smith (546), Feng Chang (542), Simon Proctor (540), Jan Krnavek (534), Niels van Dijke (494), Robert DiCicco (484), Javier Luque (460), Bruce Gray (452), Ruben Westerberg (452), Ryan Thompson (390), Stephen G. Lynn (364), Pete Houston (360), Wanderdoc (358), Bob Lied (346), Robert Ransbottom (298), Matthew Neleigh (294), Joelle Maslak (278), Thomas Kohler (274), Andrezgz (252), Ali Moradi (246), Robbie Hatley (234), David Ferrone (234), Steven Wilson (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (202), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Peter Meszaros (188), Kevin Colyer (176), Marton Polgar (174), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Solathian (152), Dave Cross (140), Shahed Nooshmand (140), Matthias Muth (138), Andinus (132), Pip Stuart (132), Avery Adams (128), Cristina Heredia (126), Joan Mimosinnet (120), BarrOff (118), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
