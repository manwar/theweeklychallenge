...
The total contributions in the week is `127`. Well done **Team PWC**. I would also like to thank `Raku` contributors for catching up.
...
#### 2. Roger Bell_West (1522)
    Bash (1), JavaScript (156), Kotlin (161), Lua (152), Postscript (197), Python (296), Ruby (284), Rust (275).
#### 3. Paulo Custodio (962)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (224), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (552)
    Awk (3), C (2), C++ (208), Haskell (243), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (77).
#### 5. Lubos Kolouch (514)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (448), Ruby (1), VBA (1).
#### 6. Stuart Little (436)
...
#### 8. Ali Moradi (383)
    Ada (14), C (33), C++ (45), D (42), Go (2), Haskell (2), Lisp (6), Lua (54), Modula 3 (36), Nelua (12), Nim (24), OCaml (2), Oberon (31), Pascal (50), Python (26), Ruby (4).
#### 9. AhmetEmre (282)
    BQN (281), Javascript (1).
#### 10. Robert DiCicco (266)
    BASIC (2), Bash (1), Go (2), Julia (93), Lua (1), Python (50), Ruby (104), Rust (1), Tcl (12).
#### 11. Tyler Wardhaugh (252)
    Clojure (192), Fennel (8), Lua (36), Python (16).
#### 12. Eric Cheung (218)
    Excel VBA (63), Python (155).
#### 13. Adam Russell (170)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (122).
#### 14. Luca Ferrari (143)
    PostgreSQL (143).
#### 15. PokGoPun (134)
    Dart (24), Go (108), Python (2).
#### 16. David Ferrone (132)
    C (34), JavaScript (29), Python (29), Rust (40).
#### 17. Simon Green (131)
    Python (131).
#### 18. Archar Gelod (104)
    Nim (104).
#### 19. Conor Hoekstra (104)
    APL (59), BQN (26), C++ (2), Haskell (6), J (8), Python (2), Rust (1).
...
#### 23. Mohammad Meraj Zia (81)
    Java (73), Kotlin (8).
#### 24. Cheok-Yin Fung (78)
    Awk (3), Bash (6), Befunge-93 (1), C (1), C++ (1), Dart (4), Java (16), JavaScript (1), Julia (13), Lisp (15), Node (1), Node.js (3), Python (4), Smalltalk (9).
#### 25. Richard Park (73)
    APL (68), BQN (1), JavaScript (2), Python (2).
#### 26. Mariano Spadaccini (53)
    Bash (1), Go (19), Korn Shell (2), Octave (1), Python (20), R (1), Ruby (9).
#### 27. E. Alvarez (46)
    Go (16), JavaScript (3), Python (21), Ruby (2), Rust (4).
#### 28. Stephen G Lynn (46)
    Julia (46).
#### 29. Nuno Vieira (44)
    JavaScript (44).
...
#### 40. Steven Wilson (18)
    Haskell (1), JavaScript (4), Python (12), Rust (1).
#### 41. Andreas Voegele (16)
    Kotlin (16).
#### 42. Orestis Zekai (16)
    Python (16).
#### 43. Vamsi Meenavilli (15)
    Java (1), Python (14).
#### 44. Lucas Ransan (14)
...
#### 58. Shawak (8)
    Ruby (8).
#### 59. Andrew Grangaard (6)
    Python (4), Rust (2).
#### 60. BarrOff (6)
    Awk (1), GP (2), Julia (2), V (1).
#### 61. Henry Wong (6)
    PHP (6).
#### 62. Michael DiCicco (6)
    Java (3), Python (3).
#### 63. W. Luis Mochan (6)
...
#### 66. Joao Felipe (5)
    APL (3), Python (2).
#### 67. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 68. Ben Davies (4)
    Idris (2), Scala (2).
#### 69. E. Choroba (4)
    C (1), Erlang (3).
#### 70. Julien Fiegehenn (4)
    TypeScript (4).
#### 71. Karishma Rajput (4)
...
#### 78. Andinus (3)
    C (3).
#### 79. Andrii Mishchenko (3)
    Ruby (3).
#### 80. Gabor Szabo (3)
    Crystal (3).
#### 81. Guillermo Ramos (3)
    Go (3).
#### 82. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 83. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 84. Rage311 (3)
    Rust (3).
#### 85. Carlos Oliveira (2)
    C (2).
#### 86. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 87. Humberto Massa (2)
    C++ (2).
#### 88. Kjetil Skotheim (2)
    Scala (2).
#### 89. Mark Anderson (2)
    PowerShell (2).
#### 90. Mark Senn (2)
...
#### 99. David Schwartz (1)
    Python (1).
#### 100. Gurunandan Bhat (1)
    Go (1).
#### 101. Jaldhar H. Vyas (1)
    C++ (1).
#### 102. Maxim Kolodyazhny (1)
    Elixir (1).
#### 103. Robbie Hatley (1)
    C (1).
#### 104. Roman Kotelnikov (1)
    J (1).
#### 105. Stephen G. Lynn (1)
    Julia (1).
...
***
    ...
    Python (2007), Haskell (572), Ruby (564), C (559), Lua (499), Rust (437), C++ (396), BQN (309), JavaScript (268), Go (265), Java (260), Postscript (216), Kotlin (208), Julia (205), Node.js (196), Clojure (192), Awk (190), PostgreSQL (143), Nim (142), Pascal (139), Bash (132), APL (130), Prolog (129), BASIC (100), Forth (92), Tcl (89), Bc (84), D (76), R (75), Scala (70), Excel VBA (63), Scheme (58), Lisp (51), PHP (41), Swift (41), Dart (40), Modula 3 (36), Ada (35), Befunge-93 (35), Fortran (33), Oberon (31), OCaml (27), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), F# (12), Nelua (12), J (9), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), PowerShell (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2270), Jaldhar H. Vyas (2130), Roger Bell_West (2032), Luca Ferrari (1740), Flavio Poletti (1668), Arne Sommer (1666), Athanasius (1398), Lubos Kolouch (1366), Colin Crain (1336), Ulrich Rieke (1258), Adam Russell (1084), Dave Jacoby (1022), E. Choroba (1004), Paulo Custodio (912), James Smith (860), Jorg Sommrey (860), W. Luis Mochan (832), Duncan C. White (794), Simon Green (756), Cheok-Yin Fung (720), Mohammad Sajid Anwar (718), Mark Anderson (712), Stuart Little (644), Abigail (574), Peter Campbell Smith (546), Feng Chang (542), Simon Proctor (540), Jan Krnavek (534), Niels van Dijke (494), Robert DiCicco (484), Javier Luque (460), Bruce Gray (452), Ruben Westerberg (452), Ryan Thompson (390), Bob Lied (370), Stephen G. Lynn (364), Pete Houston (360), Wanderdoc (358), Robert Ransbottom (298), Matthew Neleigh (294), Joelle Maslak (278), Thomas Kohler (274), Andrezgz (252), Ali Moradi (246), Robbie Hatley (234), David Ferrone (234), Steven Wilson (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (202), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Peter Meszaros (188), Kevin Colyer (176), Marton Polgar (174), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Reinier Maliepaard (156), Solathian (152), Dave Cross (140), Shahed Nooshmand (140), Matthias Muth (138), Andinus (132), Pip Stuart (132), Avery Adams (128), Cristina Heredia (126), Joan Mimosinnet (120), BarrOff (118), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/cheok-yin-fung/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/cheok-yin-fung/perl/ch-2.pl)]
...
[[**BLOG #1**](https://egroup.kolouch.org/nextcloud/sites/lubos/2023-07-31_Weekly_challenge_228)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/reinier-maliepaard/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/reinier-maliepaard/perl/ch-2.pl)]
[[**BLOG #1**](https://reiniermaliepaard.nl/pwc/index.php?id=pwc228-1)]
[[**BLOG #2**](https://reiniermaliepaard.nl/pwc/index.php?id=pwc228-2)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/massa/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/massa/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/barroff/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/barroff/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/barroff/raku/ch-1.p6)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/barroff/raku/ch-2.p6)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-228/robert-dicicco/perl/ch-1.pl)]
