...
#### 1. Abigail (678)
    Awk (70), Bash (61), Basic (9), Bc (17), Befunge (21), Brainfuck (1), C (74), C Shell (6), COBOL (6), Chef (1), Erlang (5), Forth (6), Fortran (8), Go (16), Java (15), Lua (60), M4 (1), MMIX (2), Macro Processor (4), Mumps (1), Node.js (79), OCaml (5), Ook (1), PHP (5), Pascal (18), Postscript (4), Python (64), R (15), Rexx (5), Ruby (60), SQL (10), Scheme (12), Sed (5), Tcl (11).
#### 2. Stuart Little (396)
