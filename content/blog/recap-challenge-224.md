...
The total contributions in the week is `74`. Well done **Team PWC**. I would also like to thanks `Raku` contributors for catching up.
...
#### 7. Ali Moradi (333)
    Ada (14), C (27), C++ (41), D (38), Haskell (2), Lua (46), Modula 3 (32), Nelua (12), Nim (24), OCaml (2), Oberon (27), Pascal (46), Python (22).
#### 8. Lubos Kolouch (324)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (285), Ruby (1), VBA (1).
#### 9. AhmetEmre (282)
...
#### 16. Simon Green (123)
    Python (123).
#### 17. Duncan C. White (103)
    C (94), Pascal (6), Postscript (3).
#### 18. Mohammad S Anwar (103)
