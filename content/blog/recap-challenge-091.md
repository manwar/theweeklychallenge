---
title: "RECAP - The Weekly Challenge - 091"
date: 2026-05-15T00:00:00+00:00
description: "Quick recap of The Weekly Challenge - 091."
type: post
...
#### 1. Paulo Custodio (323)
    Ada (2), Awk (12), BASIC (10), Bc (8), Brainfuck (3), C (55), C++ (24), D (1), Forth (12), Fortran (1), Lua (12), Pascal (1), Python (182).
#### 2. Stuart Little (218)
    Haskell (182), Lua (36).
#### 3. Lubos Kolouch (217)
    Bash (1), C++ (1), Go (5), Java (23), JavaScript (1), Kotlin (2), PHP (1), Python (181), Ruby (1), VBA (1).
#### 4. Abigail (179)
    Awk (16), BASIC (2), Bash (12), Bc (8), Befunge-93 (6), Brainfuck (1), C (20), C Shell (1), COBOL (1), Chef (1), Forth (1), Fortran (1), Go (7), Java (7), Lua (10), Mumps (1), Node.js (28), Ook (1), Pascal (8), Python (12), R (7), Ruby (12), SQL (4), Scheme (7), Tcl (5).
#### 5. AhmetEmre (176)
    BQN (176).
#### 6. David Ferrone (116)
...
#### 9. Ulrich Rieke (77)
    C++ (32), Haskell (45).
#### 10. Roger Bell_West (71)
    Postscript (2), Python (35), Ruby (23), Rust (11).
#### 11. Tyler Wardhaugh (60)
    Clojure (38), Lua (22).
#### 12. Richard Park (50)
...
#### 16. Adam Russell (27)
    C++ (11), Prolog (16).
#### 17. Conor Hoekstra (25)
    APL (12), BQN (10), C++ (1), Haskell (1), J (1).
#### 18. Cheok-Yin Fung (24)
    Java (5), Lisp (11), Python (3), Smalltalk (5).
#### 19. PokGoPun (22)
    Dart (6), Go (16).
#### 20. Shawn Wagner (21)
...
#### 21. User Person (21)
    Python (21).
#### 22. Laurent Rosenfeld (19)
    Gembase (1), Python (4), Scala (14).
...
#### 41. Yet Ebreo (4)
    Python (2), Ruby (2).
#### 42. Andrii Mishchenko (3)
    Ruby (3).
#### 43. Duncan C. White (3)
    Postscript (3).
#### 44. E. Choroba (3)
    C (1), Erlang (2).
#### 45. Frank Oosterhuis (3)
    Scala (3).
#### 46. Rage311 (3)
    Rust (3).
#### 47. Ali Moradi (2)
...
#### 55. Jan Krnavek (1)
    Scala (1).
#### 56. Karishma Rajput (1)
    Node.js (1).
#### 57. Lance Wicks (1)
    Elm (1).
#### 58. Mohammad Meraj Zia (1)
    Java (1).
#### 59. Steven Wilson (1)
    Rust (1).
...
***
    ...
    Python (546), Haskell (277), BQN (186), C (115), Nim (106), C++ (88), Lua (81), JavaScript (63), APL (58), Rust (55), Ruby (51), Go (48), Java (40), Clojure (38), Node.js (35), Lisp (34), Awk (32), Prolog (19), R (19), Scala (19), Swift (18), Bash (17), Bc (16), Tcl (16), Forth (13), BASIC (12), Elm (11), Pascal (10), PHP (9), OCaml (8), Dart (7), Scheme (7), Befunge-93 (6), Kotlin (5), Postscript (5), Smalltalk (5), Brainfuck (4), SQL (4), Fortran (3), Ada (2), D (2), Erlang (2), HTML (2), Haxe (2), Idris (2), C Shell (1), C# (1), COBOL (1), Chef (1), Fish (1), GNAT (1), Gembase (1), J (1), Julia (1), Mumps (1), Ook (1), VBA (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (992), Jaldhar H. Vyas (840), Roger Bell_West (676), Arne Sommer (632), Colin Crain (524), Athanasius (486), Javier Luque (460), Ruben Westerberg (452), E. Choroba (450), Adam Russell (436), Mohammad Sajid Anwar (394), Lubos Kolouch (382), Paulo Custodio (364), Stuart Little (364), Dave Jacoby (360), Simon Proctor (354), Ulrich Rieke (332), Jorg Sommrey (328), Duncan C. White (312), Ryan Thompson (282), Joelle Maslak (274), Luca Ferrari (268), Cheok-Yin Fung (232), Andrezgz (222), Mark Anderson (212), Yet Ebreo (212), Wanderdoc (200), Myoungjin Jeon (192), Noud Aldenhoven (188), Markus Holzer (186), Kevin Colyer (176), Feng Chang (174), Kian-Meng Ang (162), Walt Mankowski (162), Steven Wilson (152), Andrew Shitov (150), Duane Powell (144), Shahed Nooshmand (140), Simon Green (134), Pete Houston (120), Flavio Poletti (118), Niels van Dijke (116), Abigail (112), James Smith (112), Julio de Castro (112), Saif Ahmed (110), Alicia Bielsa (106), Burkhard Nickels (106), Dave Cross (100).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/alexander-pankoff/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/e-choroba/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/lubos-kolouch/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/sgreen/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/colin-crain/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/colin-crain/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/colin-crain/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/colin-crain/raku/ch-2.raku)]
[[**BLOG #1**](https://colincrain.com/2020/12/20/one-2-one-1-jump-street/)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-091/roger-bell-west/perl/ch-1.pl)]
