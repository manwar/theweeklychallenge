...
#### 1. Abigail (443)
    Awk (46), Bash (37), Basic (7), Bc (10), Befunge (15), Brainfuck (1), C (51), C Shell (5), COBOL (5), Chef (1), Erlang (4), Forth (5), Fortran (7), Go (6), Java (5), Lua (38), MMIX (1), Macro Processor (4), Mumps (1), Node.js (57), OCaml (4), Ook (1), PHP (4), Pascal (11), Postscript (3), Python (42), R (7), Rexx (4), Ruby (38), SQL (9), Scheme (6), Sed (4), Tcl (4).
#### 2. Stuart Little (252)
    Haskell (224), Node.js (12), Python (16).
#### 3. Paulo Custodio (224)
    Ada (14), Awk (20), Basic (36), Bc (2), C (26), C++ (26), Forth (34), Lua (30), Python (36).
#### 4. Roger Bell_West (192)
...
***
    ...
    Python (394), Haskell (332), Ruby (120), C++ (110), Lua (107), C (96), Awk (79), Node.js (78), Clojure (74), Rust (74), APL (58), JavaScript (48), Java (44), Bash (43), Basic (43), Scala (40), Forth (39), Lisp (37), Prolog (37), Go (34), R (19), Swift (18), Befunge (15), PHP (15), Pascal (15), Tcl (15), Ada (14), Elm (14), Bc (13), Kotlin (13), OCaml (12), Fortran (9), SQL (9), Julia (8), Postscript (8), Smalltalk (8), D (6), Erlang (6), Scheme (6), C Shell (5), COBOL (5), Macro Processor (4), Nim (4), Rexx (4), Sed (4), Gembase (3), Janet (3), Dart (2), HTML (2), Haxe (2), Idris (2), BQN (1), Brainfuck (1), C# (1), Chef (1), Fish (1), GNAT (1), MMIX (10, Mumps (1), Ook (1), Visual Basic (1), XSLT (1)
