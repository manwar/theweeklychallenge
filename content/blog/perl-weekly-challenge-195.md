...
We missed the target after the `10th consecutive weeks`. I am sure, with late submissions, we would definitely get there. Thank you `Team PWC` for the support and encouragement.
...
Last week, we had `32` regular contributors and `10` guest contributors. Thank you everyone for the support and encouragement.
