...
#### 1. Abigail (611)
    Awk (64), Bash (55), Basic (8), Bc (14), Befunge (19), Brainfuck (1), C (68), C Shell (6), COBOL (6), Chef (1), Erlang (5), Forth (6), Fortran (8), Go (13), Java (12), Lua (54), M4 (1), MMIX (2), Macro Processor (4), Mumps (1), Node.js (73), OCaml (5), Ook (1), PHP (5), Pascal (15), Postscript (4), Python (58), R (11), Rexx (5), Ruby (54), SQL (10), Scheme (9), Sed (5), Tcl (8).
#### 2. Paulo Custodio (349)
    Ada (19), Awk (25), Basic (41), Bc (14), Brainfuck (1), C (55), C++ (55), D (12), Forth (39), Fortran (6), Lua (35), Pascal (4), Python (43).
#### 3. Stuart Little (330)
    Haskell (240), Lua (30), Node.js (28), Python (32).
#### 4. Roger Bell_West (239)
    Bash (1), Postscript (4), Python (90), Ruby (78), Rust (66).
#### 5. Ulrich Rieke (142)
    Awk (1), C (2), C++ (60), Haskell (72), Java (1), Lisp (6).
#### 6. Tyler Wardhaugh (136)
...
#### 12. Nuno Vieira (44)
    JavaScript (44).
#### 13. Mohammad Meraj Zia (39)
    Java (31), Kotlin (8).
#### 14. Cheok-Yin Fung (37)
...
#### 20. Orestis Zekai (16)
    Python (16).
#### 21. Cristina Heredia (14)
    Python (14).
#### 22. Dave Jacoby (13)
    HTML (1), Node.js (10), Rust (2).
#### 23. Colin Crain (12)
    Python (12).
#### 24. Frank Oosterhuis (12)
    Scala (12).
#### 25. Pete Houston (12)
