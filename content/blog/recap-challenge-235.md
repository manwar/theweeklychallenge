...
The total contributions in the week is `125`. Well done **Team PWC**. I would also like to thank `Raku` contributors for catching up.
...
#### 1. Roger Bell_West (1608)
    Bash (1), JavaScript (168), Kotlin (173), Lua (164), Postscript (209), Python (308), Ruby (296), Rust (287), Scala (2).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (974)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (236), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (587)
    Awk (3), C (2), C++ (219), Haskell (255), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (89).
#### 5. Lubos Kolouch (526)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (460), Ruby (1), VBA (1).
#### 6. Ali Moradi (449)
    Ada (14), C (39), C++ (49), D (44), Go (6), Haskell (4), Java (2), Lisp (14), Lua (64), Modula 3 (42), Nelua (12), Nim (24), OCaml (4), Oberon (33), Pascal (56), Python (30), Ruby (12).
#### 7. Stuart Little (436)
...
#### 9. Robert DiCicco (310)
    BASIC (2), Bash (1), Go (2), Julia (103), Lua (2), PowerShell (2), Python (61), Ruby (115), Rust (1), Tcl (21).
#### 10. AhmetEmre (282)
    BQN (281), Javascript (1).
#### 11. Tyler Wardhaugh (260)
    Clojure (200), Fennel (8), Lua (36), Python (16).
#### 12. Eric Cheung (230)
    Excel VBA (63), Python (167).
#### 13. Adam Russell (176)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (128).
#### 14. PokGoPun (158)
    Dart (24), Go (120), Python (14).
#### 15. Luca Ferrari (155)
    PostgreSQL (155).
#### 16. Simon Green (141)
    Python (141).
...
#### 30. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 31. Steven Wilson (38)
    Haskell (1), JavaScript (13), Python (23), Rust (1).
#### 32. Andrew Shitov (34)
...
#### 99. Bob Lied (1)
    C (1).
#### 100. Christian Jaeger (1)
    Haskell (1).
#### 101. Daniel Aberger (1)
    Go (1).
#### 102. Darren Bottin (1)
    Prolog (1).
#### 103. David Schwartz (1)
    Python (1).
#### 104. Gurunandan Bhat (1)
    Go (1).
#### 105. Jaldhar H. Vyas (1)
    C++ (1).
#### 106. Maxim Kolodyazhny (1)
    Elixir (1).
#### 107. Robbie Hatley (1)
    C (1).
#### 108. Roman Kotelnikov (1)
    J (1).
#### 109. Stephen G. Lynn (1)
    Julia (1).
...
***
    ...
    Python (2099), Ruby (595), Haskell (590), C (577), Lua (522), Rust (461), C++ (411), BQN (315), JavaScript (293), Go (281), Java (267), Postscript (228), Kotlin (226), Julia (225), Clojure (200), Node.js (196), Awk (190), PostgreSQL (155), Nim (146), Pascal (145), APL (137), Prolog (135), Bash (132), BASIC (100), Tcl (98), Forth (92), Bc (84), D (78), R (75), Scala (74), Excel VBA (63), Lisp (59), Scheme (58), Modula 3 (42), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), Oberon (33), OCaml (29), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), F# (12), Nelua (12), J (11), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), PowerShell (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2334), Jaldhar H. Vyas (2190), Roger Bell_West (2092), Luca Ferrari (1836), Arne Sommer (1702), Flavio Poletti (1668), Athanasius (1446), Lubos Kolouch (1410), Colin Crain (1336), Ulrich Rieke (1306), Adam Russell (1108), Dave Jacoby (1056), E. Choroba (1028), Paulo Custodio (936), Jorg Sommrey (884), W. Luis Mochan (868), James Smith (860), Duncan C. White (794), Simon Green (784), Cheok-Yin Fung (740), Mark Anderson (736), Mohammad Sajid Anwar (718), Stuart Little (644), Peter Campbell Smith (580), Abigail (574), Feng Chang (566), Jan Krnavek (558), Simon Proctor (540), Robert DiCicco (528), Niels van Dijke (514), Bruce Gray (476), Javier Luque (460), Ruben Westerberg (452), Bob Lied (402), Stephen G. Lynn (400), Ryan Thompson (390), Wanderdoc (374), Pete Houston (360), Thomas Kohler (322), Robert Ransbottom (318), Matthew Neleigh (314), Ali Moradi (306), Joelle Maslak (278), Robbie Hatley (270), David Ferrone (258), Andrezgz (252), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), Peter Meszaros (212), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Reinier Maliepaard (180), Marton Polgar (178), Kevin Colyer (176), Solathian (176), Aaron Smith (174), Matthias Muth (174), Avery Adams (164), Duane Powell (164), Kian-Meng Ang (162), BarrOff (158), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**BLOG #1**](https://jacoby.github.io/2023/09/20/there-goes-my-zero-weekly-challenge-235.html
)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/matthias-muth/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/paulo-custodio/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/massa/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-235/jaldhar-h-vyas/perl/ch-1.pl)]
...
[[**BLOG #1**](https://packy.dardan.com/2023/09/18/perl-weekly-challenge-remove-and-duplicate-challenge-edition/)]
