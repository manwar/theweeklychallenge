...
#### 6. Ali Moradi (431)
    Ada (14), C (37), C++ (47), D (42), Go (4), Haskell (4), Java (2), Lisp (14), Lua (62), Modula 3 (40), Nelua (12), Nim (24), OCaml (4), Oberon (31), Pascal (54), Python (30), Ruby (10).
...
#### 8. Lubos Kolouch (390)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (351), Ruby (1), VBA (1).
...
#### 28. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 29. Steven Wilson (37)
    Haskell (1), JavaScript (13), Python (22), Rust (1).
#### 30. Andrew Shitov (34)
...
#### 52. Lance Wicks (10)
    Elm (5), Go (4), Python (1).
#### 53. Packy Anderson (10)
    Java (4), Python (6).
#### 54. Kang-min Liu (9)
    Janet (3), Kotlin (2), Python (2), Rust (2).
#### 55. Asher Harvey-Smith (8)
    APL (2), BQN (2), Haskell (2), J (2).
#### 56. Aviral Goel (8)
    Haskell (8).
#### 57. Burkhard Nickels (8)
    Python (8).
#### 58. Jan Krnavek (8)
    Julia (7), Scala (1).
#### 59. Sangeet Kar (8)
...
#### 97. Bob Lied (1)
    C (1).
#### 98. Christian Jaeger (1)
    Haskell (1).
#### 99. Daniel Aberger (1)
    Go (1).
#### 100. Darren Bottin (1)
    Prolog (1).
#### 101. David Schwartz (1)
    Python (1).
#### 102. Gurunandan Bhat (1)
    Go (1).
#### 103. Jaldhar H. Vyas (1)
    C++ (1).
#### 104. Maxim Kolodyazhny (1)
    Elixir (1).
#### 105. Robbie Hatley (1)
    C (1).
#### 106. Roman Kotelnikov (1)
    J (1).
#### 107. Stephen G. Lynn (1)
    Julia (1).
