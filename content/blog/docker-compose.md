...
3. [Plan](#plan)
   - 3.1 [Create a Docker Network](#create-a-docker-network)
   - 3.2 [Create the MongoDB Container](#create-the-mongodb-container)
   - 3.3 [Create the Mongo Express Container](#create-the-mongo-express-container)
   - 3.4 [Verify Containers](#verify-containers)
   - 3.5 [Test Connection](#test-connection)
