...
#### 1. Roger Bell_West (2278)
    Bash (1), Crystal (18), JavaScript (249), Kotlin (254), Lua (244), Postscript (292), Python (389), Ruby (377), Rust (371), Scala (83).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1076)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (320), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (808)
    Awk (3), C (2), C++ (291), Haskell (329), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (164).
#### 5. Ali Moradi (641)
    APL (1), Ada (14), C (55), C++ (61), D (56), Go (17), Haskell (10), Java (24), Lisp (20), Lua (82), Modula 3 (70), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (36), Ruby (26), Scheme (2), Standard ML (4), Zig (2).
#### 6. Lubos Kolouch (610)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (544), Ruby (1), VBA (1).
#### 7. Stuart Little (436)
...
#### 9. Luca Ferrari (365)
    Java (50), PostgreSQL (237), Python (78).
#### 10. David Ferrone (352)
    C (89), JavaScript (84), Python (84), Rust (95).
#### 11. Robert DiCicco (350)
    BASIC (2), Bash (1), Go (2), Julia (111), Lua (2), PowerShell (11), Python (71), Ruby (124), Rust (1), Tcl (25).
#### 12. PokGoPun (326)
    Dart (24), Go (204), Python (98).
#### 13. Eric Cheung (314)
    Excel VBA (63), Python (251).
#### 14. AhmetEmre (282)
...
#### 18. Conor Hoekstra (128)
    APL (63), BQN (44), C++ (2), Haskell (6), J (8), Python (2), Rust (1), Uiua (2).
#### 19. Archar Gelod (124)
    Nim (124).
#### 20. Packy Anderson (119)
    Elixir (22), Java (8), Python (89).
#### 21. Duncan C. White (103)
    C (94), Pascal (6), Postscript (3).
#### 22. Mohammad Sajid Anwar (103)
    Java (27), Python (35), Swift (41).
#### 23. BarrOff (102)
    Awk (1), BQN (9), D (3), GP (2), Julia (59), Nim (25), V (3).
#### 24. Steven Wilson (100)
    Haskell (1), JavaScript (13), Python (85), Rust (1).
#### 25. Mariano Spadaccini (93)
    Bash (1), Elixir (12), Go (29), Korn Shell (2), Octave (1), Python (32), R (1), Ruby (15).
#### 26. Mohammad Meraj Zia (86)
    Java (78), Kotlin (8).
#### 27. Cheok-Yin Fung (85)
    Awk (3), Bash (6), Befunge-93 (1), C (1), C++ (1), Dart (4), Java (16), JavaScript (1), Julia (13), Lisp (22), Node (1), Node.js (3), Python (4), Smalltalk (9).
...
#### 38. Andrew Schneider (34)
    C (8), C++ (4), Erlang (2), Haskell (6), Julia (4), Prolog (4), Racket (2), Rust (4).
#### 39. Bruce Gray (34)
...
***
    ...
    Python (2904), C (742), Ruby (706), Haskell (686), Rust (681), Lua (620), C++ (524), JavaScript (447), Go (389), BQN (354), Java (350), Postscript (311), Kotlin (307), Julia (292), PostgreSQL (237), Clojure (202), Node.js (196), Awk (190), Bash (190), Nim (187), Prolog (166), Pascal (159), Scala (157), APL (150), Tcl (102), BASIC (100), Forth (98), D (93), Bc (84), R (81), Lisp (72), Modula 3 (70), Excel VBA (63), Scheme (60), PHP (51), Oberon (47), Elixir (42), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), OCaml (33), Erlang (24), SQL (24), J (23), Crystal (21), COBOL (20), Ring (20), C Shell (19), F# (18), M4 (18), Rexx (17), Sed (16), Uiua (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), Smalltalk (9), Fennel (8), Hy (8), Zig (7), Brainfuck (6), Racket (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), Nu (4), Standard ML (4), CESIL (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (2752), Laurent Rosenfeld (2732), Jaldhar H. Vyas (2610), Roger Bell_West (2508), Arne Sommer (1960), Athanasius (1772), Lubos Kolouch (1762), Flavio Poletti (1716), Ulrich Rieke (1602), Colin Crain (1336), Dave Jacoby (1280), Adam Russell (1222), E. Choroba (1198), Jorg Sommrey (1124), W. Luis Mochan (1120), Paulo Custodio (1104), Simon Green (1004), Mark Anderson (906), James Smith (882), Cheok-Yin Fung (850), Peter Campbell Smith (832), Duncan C. White (794), Feng Chang (734), Mohammad Sajid Anwar (718), Jan Krnavek (716), Bruce Gray (666), Niels van Dijke (660), Thomas Kohler (658), Stuart Little (644), Bob Lied (614), Ali Moradi (584), Abigail (574), Robert DiCicco (574), Simon Proctor (560), Packy Anderson (510), Robbie Hatley (492), Stephen G. Lynn (478), Matthew Neleigh (474), Robert Ransbottom (464), Wanderdoc (462), Javier Luque (460), Ruben Westerberg (452), David Ferrone (424), Ryan Thompson (418), Peter Meszaros (380), Pete Houston (360), Matthias Muth (338), BarrOff (332), Reinier Maliepaard (318), Joelle Maslak (314), Andrew Shitov (254), Andrezgz (252), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Aaron Smith (174), Kjetil Skotheim (168), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Nelo Tovar (146), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Mariano Spadaccini (130), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-277/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-277/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-277.html)]
...
[[**BLOG #2**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task2pljava)]
[[**BLOG #3**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task2)]
[[**BLOG #4**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task1plperl)]
[[**BLOG #5**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task2plperl)]
[[**BLOG #6**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task1plpgsql)]
[[**BLOG #7**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task2plpgpsql)]
[[**BLOG #8**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task1python)]
[[**BLOG #9**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task2python)]
[[**BLOG #10**](https://fluca1978.github.io/2024/07/11/PerlWeeklyChallenge277.html#task1pljava)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-277/packy-anderson/perl/ch-1.pl)]
