...
#### 1. Roger Bell_West (2386)
    Bash (1), Crystal (30), JavaScript (261), Kotlin (266), Lua (256), Postscript (304), Python (401), Ruby (389), Rust (383), Scala (95).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1098)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (332), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (372).
#### 4. Ulrich Rieke (844)
    Awk (3), C (2), C++ (303), Haskell (341), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (176).
#### 5. Ali Moradi (677)
    APL (1), Ada (14), C (55), C++ (65), D (56), Go (17), Haskell (10), Java (34), Lisp (20), Lua (84), Modula 3 (82), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (38), Ruby (32), Scheme (2), Standard ML (4), Zig (2).
#### 6. Lubos Kolouch (622)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (556), Ruby (1), VBA (1).
#### 7. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 8. David Ferrone (406)
    C (101), JavaScript (96), Python (96), R (6), Rust (107).
...
#### 18. Packy Anderson (143)
    Elixir (34), Java (8), Python (101).
#### 19. Conor Hoekstra (140)
    APL (63), BQN (56), C++ (2), Haskell (6), J (8), Python (2), Rust (1), Uiua (2).
#### 20. Archar Gelod (124)
    Nim (124).
#### 21. Steven Wilson (112)
    Haskell (1), JavaScript (13), Python (97), Rust (1).
#### 22. BarrOff (110)
    Awk (1), BQN (9), D (3), GP (2), Julia (67), Nim (25), V (3).
...
#### 33. Thomas Kohler (54)
    Python (54).
#### 34. Andrew Schneider (46)
    C (8), C++ (4), Erlang (2), Haskell (6), Julia (8), Prolog (4), Racket (6), Rust (8).
#### 35. E. Alvarez (46)
...
#### 82. izem (6)
    Python (6).
#### 83. Augie De Blieck Jr. (4)
    Elixir (2), JavaScript (1), Python (1).
#### 84. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 85. Ben Davies (4)
    Idris (2), Scala (2).
#### 86. Julien Fiegehenn (4)
    TypeScript (4).
#### 87. Karishma Rajput (4)
    C (1), C++ (1), JavaScript (1), Node.js (1).
#### 88. Kivanc Yazan (4)
    Python (4).
#### 89. Kjetil Skotheim (4)
    Scala (4).
#### 90. Kueppo Wesley (4)
    Node.js (4).
#### 91. Macy TY (4)
...
#### 95. Andinus (3)
    C (3).
#### 96. Andrii Mishchenko (3)
    Ruby (3).
#### 97. Gabor Szabo (3)
    Crystal (3).
#### 98. Guillermo Ramos (3)
    Go (3).
#### 99. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 100. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 101. Rage311 (3)
    Rust (3).
#### 102. Carlos Oliveira (2)
    C (2).
#### 103. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 104. Humberto Massa (2)
    C++ (2).
#### 105. Joelle Maslak (2)
    Go (2).
#### 106. Mark Anderson (2)
...
***
    ...
    Luca Ferrari (2808), Laurent Rosenfeld (2804), Jaldhar H. Vyas (2670), Roger Bell_West (2568), Arne Sommer (1996), Athanasius (1820), Lubos Kolouch (1798), Flavio Poletti (1716), Ulrich Rieke (1650), Colin Crain (1336), Dave Jacoby (1308), Adam Russell (1240), E. Choroba (1222), Jorg Sommrey (1160), W. Luis Mochan (1156), Paulo Custodio (1128), Simon Green (1022), Mark Anderson (930), James Smith (882), Cheok-Yin Fung (868), Peter Campbell Smith (868), Duncan C. White (794), Feng Chang (758), Jan Krnavek (740), Mohammad Sajid Anwar (718), Thomas Kohler (706), Niels van Dijke (676), Bruce Gray (674), Stuart Little (644), Bob Lied (640), Ali Moradi (632), Abigail (574), Robert DiCicco (574), Packy Anderson (570), Simon Proctor (560), Robbie Hatley (528), Matthew Neleigh (496), Robert Ransbottom (488), Wanderdoc (486), Stephen G. Lynn (478), Javier Luque (460), Ruben Westerberg (452), David Ferrone (448), Ryan Thompson (418), Peter Meszaros (404), Matthias Muth (368), Pete Houston (360), Reinier Maliepaard (354), BarrOff (350), Joelle Maslak (314), Andrezgz (264), Andrew Shitov (254), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Kjetil Skotheim (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Aaron Smith (174), Duane Powell (164), Nelo Tovar (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Mariano Spadaccini (130), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/atschneid/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/zapwai/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-283.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/mattneleigh/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/peter-campbell-smith/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/santiago-leyva/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/santiago-leyva/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/barroff/raku/ch-1.p6)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-283/deadmarshal/perl/ch-1.pl)]
