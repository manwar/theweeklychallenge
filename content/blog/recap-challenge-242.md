...
#### 1. Roger Bell_West (1720)
    Bash (1), JavaScript (182), Kotlin (187), Lua (178), Postscript (223), Python (322), Ruby (310), Rust (301), Scala (16).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (996)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (250), C++ (95), D (14), Forth (76), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (624)
    Awk (3), C (2), C++ (231), Haskell (267), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (102).
#### 5. Lubos Kolouch (540)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (474), Ruby (1), VBA (1).
#### 6. Ali Moradi (533)
...
#### 12. Eric Cheung (244)
    Excel VBA (63), Python (181).
#### 13. Adam Russell (188)
    C++ (26), Fortran (3), Java (16), JavaScript (2), Nuweb (3), Prolog (136), R (2).
#### 14. PokGoPun (186)
    Dart (24), Go (134), Python (28).
#### 15. Luca Ferrari (179)
    PostgreSQL (169), Python (10).
#### 16. Simon Green (153)
    Python (153).
...
#### 33. BarrOff (34)
    Awk (1), GP (2), Julia (18), Nim (12), V (1).
#### 34. Packy Anderson (28)
    Java (8), Python (20).
#### 35. Shawn Wagner (27)
...
#### 36. Andreas Voegele (22)
    Kotlin (22).
#### 37. Bruce Gray (22)
    C (3), Dart (2), F# (4), Go (2), Julia (2), Python (2), Rust (2), SVG (1), WebAssembly (2), YaBasic (2).
...
#### 67. Joao Felipe (6)
    APL (4), Python (2).
#### 68. Magnus Markling (6)
    Uiua (6).
#### 69. Michael DiCicco (6)
    Java (3), Python (3).
#### 70. W. Luis Mochan (6)
...
#### 73. Augie De Blieck Jr. (4)
    Elixir (2), JavaScript (1), Python (1).
#### 74. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 75. Ben Davies (4)
    Idris (2), Scala (2).
#### 76. E. Choroba (4)
...
***
    ...
    Python (2233), Ruby (622), Haskell (606), C (601), Lua (544), Rust (490), C++ (435), BQN (321), JavaScript (314), Go (298), Java (281), Postscript (242), Julia (240), Kotlin (240), Clojure (200), Node.js (196), Awk (190), PostgreSQL (169), Nim (154), Pascal (153), Prolog (149), APL (138), Bash (132), Tcl (102), BASIC (100), Forth (94), Scala (88), Bc (84), D (82), R (77), Lisp (66), Excel VBA (63), Scheme (58), Modula 3 (50), Oberon (43), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), OCaml (31), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), F# (16), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), J (11), Smalltalk (9), Fennel (8), Uiua (8), Brainfuck (6), Emacs Lisp (4), Factor (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Elixir (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
[[**BLOG #1**](https://github.sommrey.de/blog/pwc/challenge-242/)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-242/bruce-gray/raku/ch-1.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-242/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-242/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-242/lubos-kolouch/perl/ch-1.pl)]
