...
#### 2. Roger Bell_West (767)
    Bash (1), JavaScript (49), Kotlin (54), Lua (52), Postscript (86), Python (187), Ruby (175), Rust (163).
#### 3. Paulo Custodio (728)
    Ada (21), Awk (28), BASIC (44), Bc (17), Brainfuck (5), C (108), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (340).
#### 4. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 5. Lubos Kolouch (385)
    Bash (1), C++ (1), Go (5), Java (33), JavaScript (1), Kotlin (2), PHP (7), Python (333), Ruby (1), VBA (1).
#### 6. Ulrich Rieke (283)
    Awk (1), C (2), C++ (124), Haskell (146), Java (3), Lisp (7).
#### 7. AhmetEmre (234)
    BQN (234).
...
#### 23. Robert DiCicco (45)
    Bash (1), Julia (12), Python (4), Ruby (22), Tcl (6).
#### 24. Nuno Vieira (44)
    JavaScript (44).
...
#### 36. Duncan C. White (16)
    C (11), Pascal (2), Postscript (3).
#### 37. Orestis Zekai (16)
    Python (16).
#### 38. Lucas Ransan (14)
...
#### 57. Ben Davies (4)
    Idris (2), Scala (2).
#### 58. Julien Fiegehenn (4)
    TypeScript (4).
#### 59. Karishma Rajput (4)
...
***
    ...
    Python (1346), Haskell (469), Lua (351), Ruby (343), C (315), BQN (254), C++ (242), Rust (222), Go (204), Node.js (191), Java (185), Awk (178), JavaScript (144), Clojure (138), Bash (126), APL (113), Nim (112), Postscript (105), Pascal (95), Prolog (90), Bc (79), Tcl (79), Kotlin (74), R (74), BASIC (66), Excel VBA (63), Forth (60), Scheme (58), Scala (56), PostgreSQL (55), Julia (53), Lisp (41), PHP (39), Befunge-93 (35), Fortran (30), D (29), OCaml (25), Swift (25), Ada (23), SQL (23), Dart (22), Erlang (21), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Smalltalk (9), J (8), Ring (8), Brainfuck (6), Oberon (4), TypeScript (4), CESIL (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Zig (3), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), Miranda (2), Modula 3 (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1720), Jaldhar H. Vyas (1550), Roger Bell_West (1454), Arne Sommer (1294), Colin Crain (1144), Athanasius (1020), Lubos Kolouch (1018), Luca Ferrari (996), Flavio Poletti (984), Adam Russell (870), Ulrich Rieke (856), Dave Jacoby (830), E. Choroba (770), Paulo Custodio (680), Stuart Little (644), Jorg Sommrey (628), Duncan C. White (614), Mohammad Sajid Anwar (596), James Smith (580), Abigail (574), Cheok-Yin Fung (530), Simon Proctor (488), Mark Anderson (486), W. Luis Mochan (480), Simon Green (474), Javier Luque (460), Ruben Westerberg (452), Ryan Thompson (378), Feng Chang (374), Niels van Dijke (360), Pete Houston (360), Wanderdoc (358), Jan Krnavek (340), Joelle Maslak (274), Andrezgz (252), Yet Ebreo (222), Peter Campbell Smith (216), Bruce Gray (208), Markus Holzer (198), Steven Wilson (198), Myoungjin Jeon (192), Noud Aldenhoven (188), Alexander Pankoff (184), Andrew Shitov (182), Kevin Colyer (176), Matthew Neleigh (176), Aaron Smith (174), Walt Mankowski (172), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Robert DiCicco (150), Shahed Nooshmand (140), Cristina Heredia (126), Bob Lied (124), Dave Cross (120), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Andinus (112), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/bob-lied/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/bob-lied/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/e-choroba/perl/ch-1.pl)]
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-170.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/paulo-custodio/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-170/habere-et-dispetire/raku/ch-1.raku)]
