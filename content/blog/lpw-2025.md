...
type: post
image: images/blog/lpw-2025.png
...
After my talk, I attended [**A Whistlestop Tour of Banking Interchange Formats**](http://act.yapc.eu/lpw2025/talk/7990).

Then came lunchtime.

It was an honor to have lunch with `Paul Evans` and `Boyd Duffee` at a nearby `Persian restaurant`. At the table, `Paul` and I discussed the `Singleton` pattern from my presentation. He had a brand-new idea for implementing it more elegantly using `Object::Pad`, and he was tossing around names for it.
