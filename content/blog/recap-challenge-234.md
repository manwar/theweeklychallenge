...
#### 1. Roger Bell_West (1592)
    Bash (1), JavaScript (166), Kotlin (171), Lua (162), Postscript (207), Python (306), Ruby (294), Rust (285).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (972)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (234), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (581)
    Awk (3), C (2), C++ (217), Haskell (253), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (87).
#### 5. Lubos Kolouch (524)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (458), Ruby (1), VBA (1).
#### 6. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 7. Ali Moradi (433)
    Ada (14), C (37), C++ (47), D (44), Go (4), Haskell (4), Java (2), Lisp (14), Lua (62), Modula 3 (40), Nelua (12), Nim (24), OCaml (4), Oberon (31), Pascal (54), Python (30), Ruby (10).
...
#### 9. Robert DiCicco (300)
    BASIC (2), Bash (1), Go (2), Julia (101), Lua (2), Python (59), Ruby (113), Rust (1), Tcl (19).
#### 10. AhmetEmre (282)
    BQN (281), Javascript (1).
#### 11. Tyler Wardhaugh (260)
    Clojure (200), Fennel (8), Lua (36), Python (16).
#### 12. Eric Cheung (228)
    Excel VBA (63), Python (165).
#### 13. Adam Russell (176)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (128).
#### 14. PokGoPun (154)
    Dart (24), Go (118), Python (12).
#### 15. Luca Ferrari (153)
    PostgreSQL (153).
#### 16. Simon Green (139)
    Python (139).
...
#### 30. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 31. Steven Wilson (36)
    Haskell (1), JavaScript (13), Python (21), Rust (1).
#### 32. Andrew Shitov (34)
...
#### 68. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 69. Ben Davies (4)
    Idris (2), Scala (2).
#### 70. E. Choroba (4)
    C (1), Erlang (3).
#### 71. Julien Fiegehenn (4)
    TypeScript (4).
#### 72. Karishma Rajput (4)
    C (1), C++ (1), JavaScript (1), Node.js (1).
#### 73. Kivanc Yazan (4)
    Python (4).
#### 74. Kjetil Skotheim (4)
    Scala (4).
#### 75. Kueppo Wesley (4)
    Node.js (4).
#### 76. Macy TY (4)
...
#### 81. Andinus (3)
    C (3).
#### 82. Andrii Mishchenko (3)
    Ruby (3).
#### 83. Gabor Szabo (3)
    Crystal (3).
#### 84. Guillermo Ramos (3)
    Go (3).
#### 85. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 86. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 87. Rage311 (3)
    Rust (3).
#### 88. Carlos Oliveira (2)
    C (2).
#### 89. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 90. Humberto Massa (2)
...
#### 98. Bob Lied (1)
    C (1).
#### 99. Christian Jaeger (1)
    Haskell (1).
#### 100. Daniel Aberger (1)
    Go (1).
#### 101. Darren Bottin (1)
    Prolog (1).
#### 102. David Schwartz (1)
    Python (1).
#### 103. Gurunandan Bhat (1)
    Go (1).
#### 104. Jaldhar H. Vyas (1)
    C++ (1).
#### 105. Maxim Kolodyazhny (1)
    Elixir (1).
#### 106. Robbie Hatley (1)
    C (1).
#### 107. Roman Kotelnikov (1)
    J (1).
#### 108. Stephen G. Lynn (1)
    Julia (1).
...
***
    ...
    Python (2083), Ruby (589), Haskell (586), C (573), Lua (518), Rust (457), C++ (407), BQN (311), JavaScript (291), Go (277), Java (265), Postscript (226), Kotlin (224), Julia (221), Clojure (200), Node.js (196), Awk (190), PostgreSQL (153), Nim (146), Pascal (143), APL (135), Prolog (135), Bash (132), BASIC (100), Tcl (96), Forth (92), Bc (84), D (78), R (75), Scala (72), Excel VBA (63), Lisp (59), Scheme (58), PHP (41), Swift (41), Dart (40), Modula 3 (40), Ada (35), Befunge-93 (35), Fortran (33), Oberon (31), OCaml (29), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), F# (12), Nelua (12), J (9), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), PowerShell (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2322), Jaldhar H. Vyas (2180), Roger Bell_West (2082), Luca Ferrari (1820), Arne Sommer (1696), Flavio Poletti (1668), Athanasius (1438), Lubos Kolouch (1400), Colin Crain (1336), Ulrich Rieke (1298), Adam Russell (1108), Dave Jacoby (1050), E. Choroba (1024), Paulo Custodio (932), Jorg Sommrey (880), W. Luis Mochan (862), James Smith (860), Duncan C. White (794), Simon Green (778), Cheok-Yin Fung (736), Mark Anderson (732), Mohammad Sajid Anwar (718), Stuart Little (644), Abigail (574), Peter Campbell Smith (574), Feng Chang (562), Jan Krnavek (554), Simon Proctor (540), Robert DiCicco (520), Niels van Dijke (510), Bruce Gray (472), Javier Luque (460), Ruben Westerberg (452), Bob Lied (396), Stephen G. Lynn (394), Ryan Thompson (390), Wanderdoc (370), Pete Houston (360), Robert Ransbottom (318), Thomas Kohler (314), Matthew Neleigh (310), Ali Moradi (296), Joelle Maslak (278), Robbie Hatley (264), David Ferrone (254), Andrezgz (252), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), Peter Meszaros (208), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Reinier Maliepaard (180), Marton Polgar (178), Kevin Colyer (176), Aaron Smith (174), Solathian (172), Matthias Muth (168), Duane Powell (164), Kian-Meng Ang (162), Avery Adams (156), Mark Senn (156), BarrOff (150), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/perlboy1967/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/perlboy1967/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/paulo-custodio/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/massa/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/jaldhar-h-vyas/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/jaldhar-h-vyas/raku/ch-1.sh)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/jaldhar-h-vyas/raku/ch-2.raku)]
[[**BLOG #1**](https://www.braincells.com/perl/2023/09/perl_weekly_challenge_week_234.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-234/roger-bell-west/perl/ch-1.pl)]
