...
#### 7. Ali Moradi (331)
    Ada (14), C (27), C++ (41), D (38), Haskell (2), Lua (46), Modula 3 (32), Nelua (12), Nim (24), Oberon (27), Pascal (46), Python (22).
#### 8. Lubos Kolouch (273)
    Bash (6), C++ (1), Go (2), Java (5), JavaScript (1), PHP (9), Python (247), Ruby (1), VBA (1).
#### 9. AhmetEmre (252)
    BQN (252).
...
#### 76. Gabor Szabo (3)
    Crystal (3).
#### 77. Guillermo Ramos (3)
    Go (3).
#### 78. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 79. Rage311 (3)
    Rust (3).
#### 80. Carlos Oliveira (2)
    C (2).
#### 81. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 82. Humberto Massa (2)
