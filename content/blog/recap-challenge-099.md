...
#### 1. Paulo Custodio (421)
    Ada (10), Awk (16), BASIC (26), Bc (8), Brainfuck (3), C (69), C++ (38), D (1), Forth (26), Fortran (1), Lua (24), Pascal (1), Python (198).
#### 2. Stuart Little (236)
    Haskell (198), Lua (38).
#### 3. Abigail (234)
    Awk (25), BASIC (2), Bash (19), Bc (8), Befunge-93 (6), Brainfuck (1), C (29), C Shell (1), COBOL (1), Chef (1), Forth (1), Fortran (1), Go (7), Java (7), Lua (17), Mumps (1), Node.js (37), Ook (1), Pascal (8), Python (20), R (7), Ruby (18), SQL (4), Scheme (7), Tcl (5).
#### 4. Lubos Kolouch (233)
    Bash (1), C++ (1), Go (5), Java (23), JavaScript (1), Kotlin (2), PHP (1), Python (197), Ruby (1), VBA (1).
#### 5. AhmetEmre (190)
    BQN (190).
#### 6. Roger Bell_West (119)
    Postscript (2), Python (51), Ruby (39), Rust (27).
#### 7. David Ferrone (116)
    C (29), JavaScript (29), Python (29), Rust (29).
#### 8. Archar Gelod (104)
    Nim (104).
#### 9. Tyler Wardhaugh (96)
    Clojure (54), Lua (34), Python (8).
#### 10. Ulrich Rieke (93)
    C++ (40), Haskell (53).
#### 11. Myoungjin Jeon (85)
    Elm (10), Fish (1), Go (18), Haskell (34), Lisp (22).
#### 12. Richard Park (55)
    APL (50), BQN (1), JavaScript (2), Python (2).
#### 13. Nuno Vieira (44)
    JavaScript (44).
#### 14. Adam Russell (37)
    C++ (11), Prolog (26).
...
***
    ...
    Python (620), Haskell (301), BQN (201), C (138), Lua (114), C++ (110), Nim (106), JavaScript (79), Rust (74), Ruby (73), APL (62), Clojure (54), Java (51), Go (48), Awk (45), Node.js (44), Lisp (34), Prolog (29), Scala (29), BASIC (28), Forth (27), Bash (24), R (19), Swift (18), Bc (16), Tcl (16), Elm (11), Ada (10), Pascal (10), Kotlin (9), PHP (9), OCaml (8), Smalltalk (8), Dart (7), Scheme (7), Befunge-93 (6), Postscript (5), Brainfuck (4), SQL (4), Fortran (3), Janet (3), D (2), Erlang (2), HTML (2), Haxe (2), Idris (2), C Shell (1), C# (1), COBOL (1), Chef (1), Fish (1), GNAT (1), Gembase (1), J (1), Julia (1), Mumps (1), Ook (1), VBA (1), XSLT (1).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/abigail/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/abigail/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/bob-lied/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/bob-lied/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/x1mandi/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-099/mimosinnet/raku/ch-1.raku)]
