---
title: "RECAP - The Weekly Challenge - 116"
date: 2026-05-15T00:00:00+00:00
description: "Quick recap of The Weekly Challenge - 116."
type: post
...
#### 1. Abigail (549)
    Awk (56), BASIC (7), Bash (49), Bc (13), Befunge-93 (15), Brainfuck (1), C (60), C Shell (5), COBOL (5), Chef (1), Erlang (4), Forth (5), Fortran (7), Go (13), Java (12), Lua (46), M4 (4), MMIX (1), Mumps (1), Node.js (65), OCaml (4), Ook (1), PHP (4), Pascal (18), Postscript (3), Python (50), R (14), Rexx (4), Ruby (46), SQL (9), Scheme (13), Sed (4), Tcl (9).
#### 2. Paulo Custodio (524)
    Ada (16), Awk (22), BASIC (38), Bc (11), Brainfuck (3), C (79), C++ (48), D (5), Forth (36), Fortran (1), Lua (32), Pascal (1), Python (232).
#### 3. Stuart Little (340)
    Haskell (232), Lua (64), Node.js (20), Python (24).
#### 4. Lubos Kolouch (265)
    Bash (1), C++ (1), Go (5), Java (23), JavaScript (1), Kotlin (2), PHP (1), Python (229), Ruby (1), VBA (1).
#### 5. AhmetEmre (217)
    BQN (217).
#### 6. Roger Bell_West (216)
    Bash (1), Postscript (2), Python (83), Ruby (71), Rust (59).
#### 7. Ulrich Rieke (136)
    Awk (1), C (2), C++ (57), Haskell (70), Java (1), Lisp (5).
#### 8. Tyler Wardhaugh (128)
    Clojure (80), Lua (36), Python (12).
#### 9. David Ferrone (116)
...
***
    ...
    Python (810), Haskell (353), BQN (230), C (190), Lua (182), Ruby (140), C++ (138), Rust (111), Nim (108), Node.js (95), Awk (91), Clojure (80), JavaScript (79), Java (78), APL (74), Go (62), Bash (56), BASIC (45), Prolog (43), Scala (42), Forth (41), Lisp (39), R (26), Bc (25), Pascal (23), Tcl (20), Swift (18), Ada (16), PHP (16), Befunge-93 (15), Kotlin (15), Elm (14), Scheme (13), OCaml (12), D (11), Fortran (10), SQL (9), Dart (8), Julia (8), Postscript (8), Smalltalk (8), Erlang (6), C Shell (5), COBOL (5), Brainfuck (4), M4 (4), Rexx (4), Sed (4), Gembase (3), Janet (3), HTML (2), Haxe (2), Idris (2), J (2), C# (1), Chef (1), Fish (1), GNAT (1), MMIX (1), Mumps (1), Ook (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1210), Jaldhar H. Vyas (1070), Roger Bell_West (926), Arne Sommer (850), Colin Crain (746), Athanasius (644), Adam Russell (588), E. Choroba (550), Stuart Little (548), Dave Jacoby (504), Ulrich Rieke (498), Lubos Kolouch (482), Paulo Custodio (464), Javier Luque (460), Ruben Westerberg (452), Mohammad Sajid Anwar (444), Luca Ferrari (436), Jorg Sommrey (428), Duncan C. White (412), Simon Proctor (412), Cheok-Yin Fung (336), Flavio Poletti (334), Mark Anderson (302), Abigail (294), Ryan Thompson (294), Wanderdoc (278), Joelle Maslak (274), Simon Green (266), James Smith (256), Feng Chang (234), Andrezgz (222), Yet Ebreo (222), Niels van Dijke (210), Pete Houston (200), Myoungjin Jeon (192), Markus Holzer (190), Noud Aldenhoven (188), Kevin Colyer (176), Aaron Smith (172), Jan Krnavek (170), Kian-Meng Ang (162), Walt Mankowski (162), Andrew Shitov (160), W. Luis Mochan (156), Steven Wilson (154), Duane Powell (148), Shahed Nooshmand (140), Kang-min Liu (118), Julio de Castro (116), Dave Cross (112), Gustavo Chaves (112), Saif Ahmed (110), Bob Lied (108), Alicia Bielsa (106), Burkhard Nickels (106), Joan Mimosinnet (104), Nuno Vieira (104), Cristina Heredia (102).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-116/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-116/lubos-kolouch/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-116/mark-anderson/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-116/colin-crain/perl/ch-1.pl)]
