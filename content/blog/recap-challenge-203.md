...
#### 2. Roger Bell_West (1194)
    Bash (1), JavaScript (111), Kotlin (116), Lua (107), Postscript (147), Python (249), Ruby (237), Rust (226).
#### 3. Paulo Custodio (876)
    Ada (21), Awk (28), BASIC (64), Bc (17), Brainfuck (5), C (174), C++ (77), D (14), Forth (62), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Lubos Kolouch (451)
    Bash (1), C++ (1), Go (5), Java (33), JavaScript (1), Kotlin (2), PHP (7), Python (399), Ruby (1), VBA (1).
#### 5. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 6. Ulrich Rieke (431)
    Awk (1), C (2), C++ (171), Haskell (203), Java (9), Lisp (7), Rust (38).
...
#### 11. Eric Cheung (168)
    Excel VBA (63), Python (105).
#### 12. Adam Russell (166)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (118).
#### 13. Robert DiCicco (160)
    BASIC (2), Bash (1), Go (2), Julia (58), Lua (1), Python (17), Ruby (67), Tcl (12).
#### 14. PokGoPun (130)
    Dart (24), Go (106).
...
#### 31. Shawn Wagner (22)
    Java (2), OCaml (8), Prolog (1), Tcl (11).
...
#### 44. Frank Oosterhuis (12)
    Scala (12).
#### 45. Mariano Spadaccini (12)
    Bash (1), Go (6), Korn Shell (1), Python (4).
#### 46. Wanderdoc (12)
    R (12).
#### 47. James Smith (11)
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-203.html)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-203/luca-ferrari/raku/ch-1.p6)]
