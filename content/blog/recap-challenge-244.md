...
#### 3. Paulo Custodio (1008)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (254), C++ (99), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (635)
...
#### 6. Lubos Kolouch (544)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (478), Ruby (1), VBA (1).
#### 7. Stuart Little (436)
...
#### 12. Eric Cheung (248)
    Excel VBA (63), Python (185).
#### 13. Adam Russell (200)
    C++ (26), Fortran (3), Java (16), JavaScript (6), Nuweb (3), Prolog (140), R (6).
#### 14. PokGoPun (194)
    Dart (24), Go (138), Python (32).
#### 15. Luca Ferrari (187)
    PostgreSQL (173), Python (14).
#### 16. Simon Green (157)
    Python (157).
...
#### 27. Steven Wilson (51)
    Haskell (1), JavaScript (13), Python (36), Rust (1).
#### 28. E. Alvarez (46)
...
#### 31. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 32. BarrOff (36)
    Awk (1), GP (2), Julia (20), Nim (12), V (1).
#### 33. Andrew Shitov (34)
...
***
    ...
    Python (2273), Ruby (628), Haskell (610), C (607), Lua (550), Rust (498), C++ (444), JavaScript (324), BQN (321), Go (304), Java (283), Postscript (246), Kotlin (244), Julia (242), Clojure (200), Node.js (196), Awk (190), PostgreSQL (173), Pascal (155), Nim (154), Prolog (153), APL (138), Bash (136), Tcl (102), BASIC (100), Forth (98), Scala (92), Bc (84), D (84), R (81), Lisp (66), Excel VBA (63), Scheme (58), Modula 3 (52), Oberon (45), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), OCaml (31), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), F# (16), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), J (11), Smalltalk (9), Fennel (8), Uiua (8), Brainfuck (6), Zig (5), Emacs Lisp (4), Factor (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Elixir (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2394), Jaldhar H. Vyas (2280), Roger Bell_West (2182), Luca Ferrari (2006), Arne Sommer (1760), Flavio Poletti (1716), Athanasius (1518), Lubos Kolouch (1500), Ulrich Rieke (1370), Colin Crain (1336), Adam Russell (1162), Dave Jacoby (1102), E. Choroba (1064), Paulo Custodio (972), Jorg Sommrey (926), W. Luis Mochan (922), James Smith (860), Simon Green (832), Duncan C. White (794), Cheok-Yin Fung (772), Mark Anderson (772), Mohammad Sajid Anwar (718), Stuart Little (644), Peter Campbell Smith (634), Feng Chang (602), Jan Krnavek (594), Abigail (574), Robert DiCicco (566), Niels van Dijke (546), Simon Proctor (542), Bruce Gray (512), Javier Luque (460), Bob Lied (458), Ruben Westerberg (452), Stephen G. Lynn (400), Ali Moradi (396), Thomas Kohler (394), Ryan Thompson (390), Wanderdoc (386), Pete Houston (360), Matthew Neleigh (348), Robert Ransbottom (344), Robbie Hatley (318), David Ferrone (294), Joelle Maslak (278), Andrezgz (252), Peter Meszaros (248), Steven Wilson (242), Matthias Muth (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), Markus Holzer (198), Walt Mankowski (196), BarrOff (194), Myoungjin Jeon (192), Reinier Maliepaard (192), Noud Aldenhoven (188), Solathian (188), Packy Anderson (180), Marton Polgar (178), Avery Adams (176), Kevin Colyer (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Kjetil Skotheim (108), Humberto Massa (108), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-244/dave-jacoby/perl/ch-1.pl)]
...
[[**BLOG #1**](https://github.sommrey.de/blog/pwc/challenge-244/)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-244/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-244/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-244/massa/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-244/packy-anderson/perl/ch-1.pl)]
