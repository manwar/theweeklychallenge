...
#### 2. Roger Bell_West (1230)
    Bash (1), JavaScript (115), Kotlin (120), Lua (111), Postscript (153), Python (255), Ruby (243), Rust (232).
#### 3. Paulo Custodio (900)
    Ada (21), Awk (28), BASIC (70), Bc (17), Brainfuck (5), C (180), C++ (83), D (14), Forth (68), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Lubos Kolouch (462)
    Bash (3), C++ (1), Go (5), Java (35), JavaScript (1), Kotlin (2), PHP (9), Python (404), Ruby (1), VBA (1).
#### 5. Ulrich Rieke (449)
    Awk (1), C (2), C++ (177), Haskell (209), Java (9), Lisp (7), Rust (44).
#### 6. Stuart Little (436)
...
#### 8. Ali Moradi (325)
    Ada (14), C (27), C++ (39), D (36), Go (2), Haskell (2), Lua (46), Modula 3 (30), Nelua (12), Nim (22), Oberon (27), Pascal (44), Python (22), Ruby (2).
#### 9. AhmetEmre (274)
    BQN (273), Javascript (1).
#### 10. Tyler Wardhaugh (234)
    Clojure (174), Fennel (8), Lua (36), Python (16).
#### 11. Eric Cheung (174)
    Excel VBA (63), Python (111).
#### 12. Robert DiCicco (172)
    BASIC (2), Bash (1), Go (2), Julia (62), Lua (1), Python (21), Ruby (71), Tcl (12).
#### 13. Adam Russell (166)
...
#### 19. Simon Green (93)
    Python (93).
#### 20. Conor Hoekstra (92)
    APL (56), BQN (21), C++ (2), Haskell (5), J (8).
#### 21. Myoungjin Jeon (85)
    Elm (10), Fish (1), Go (18), Haskell (34), Lisp (22).
#### 22. Duncan C. White (83)
    C (74), Pascal (6), Postscript (3).
#### 23. Mohammad Meraj Zia (77)
    Java (69), Kotlin (8).
...
#### 32. Mariano Spadaccini (26)
    Bash (1), Go (11), Korn Shell (2), Octave (1), Python (10), R (1).
...
#### 75. Andinus (3)
    C (3).
#### 76. Andrii Mishchenko (3)
    Ruby (3).
#### 77. Gabor Szabo (3)
    Crystal (3).
#### 78. Guillermo Ramos (3)
    Go (3).
#### 79. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 80. Rage311 (3)
    Rust (3).
#### 81. Carlos Oliveira (2)
    C (2).
#### 82. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 83. Humberto Massa (2)
...
***
    ...
    Python (1785), Haskell (537), C (483), Ruby (476), Lua (450), Rust (354), C++ (353), BQN (295), Go (254), Java (251), JavaScript (221), Node.js (196), Awk (187), Clojure (174), Postscript (172), Julia (171), Kotlin (151), Nim (140), Pascal (133), Bash (129), APL (127), Prolog (125), PostgreSQL (115), BASIC (94), Tcl (89), Forth (86), Bc (84), R (75), D (70), Scala (68), Excel VBA (63), Scheme (58), Lisp (41), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), Modula 3 (30), Oberon (27), OCaml (25), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Nelua (12), J (9), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Zig (3), C3 (2), Dc (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Octave (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2066), Jaldhar H. Vyas (1910), Roger Bell_West (1812), Arne Sommer (1534), Luca Ferrari (1500), Flavio Poletti (1404), Colin Crain (1326), Athanasius (1280), Lubos Kolouch (1234), Ulrich Rieke (1120), Adam Russell (1062), Dave Jacoby (966), E. Choroba (916), Paulo Custodio (824), James Smith (794), Jorg Sommrey (768), Duncan C. White (750), Mohammad Sajid Anwar (718), W. Luis Mochan (700), Cheok-Yin Fung (666), Simon Green (646), Stuart Little (644), Mark Anderson (624), Abigail (574), Simon Proctor (520), Jan Krnavek (464), Javier Luque (460), Feng Chang (454), Ruben Westerberg (452), Niels van Dijke (446), Peter Campbell Smith (412), Ryan Thompson (390), Bruce Gray (364), Pete Houston (360), Wanderdoc (358), Robert DiCicco (350), Stephen G. Lynn (322), Joelle Maslak (274), Bob Lied (272), Matthew Neleigh (254), Andrezgz (252), Robert Ransbottom (224), Yet Ebreo (222), Alexander Pankoff (220), Steven Wilson (210), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Andrew Shitov (190), Noud Aldenhoven (188), Kevin Colyer (176), Aaron Smith (174), Ali Moradi (174), Duane Powell (164), Marton Polgar (162), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), David Ferrone (136), Andinus (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Robbie Hatley (110), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104), Peter Meszaros (100).
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-206.html)]
...
[[**BLOG #1**](https://github.com/MatthiasMuth/perlweeklychallenge-club/tree/muthm-206/challenge-206/matthias-muth#readme)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/jaldhar-h-vyas/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/jaldhar-h-vyas/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-206/jaldhar-h-vyas/raku/ch-2.raku)]
[[**BLOG #1**](https://www.braincells.com/perl/2023/03/perl_weekly_challenge_week_206.html)]
