...
#### 4. Ulrich Rieke (539)
    Awk (3), C (2), C++ (203), Haskell (239), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (73).
#### 5. Stuart Little (436)
...
#### 8. Lubos Kolouch (340)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (301), Ruby (1), VBA (1).
#### 9. AhmetEmre (282)
