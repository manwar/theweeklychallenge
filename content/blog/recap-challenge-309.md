...
#### 6. Lubos Kolouch (500)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (461), Ruby (1), VBA (1).
#### 7. David Ferrone (474)
...
#### 18. Conor Hoekstra (200)
    APL (65), BQN (103), C++ (2), Haskell (6), J (8), Kap (4), Python (3), Rust (1), Uiua (8).
