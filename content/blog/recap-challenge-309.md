...
#### 1. Roger Bell_West (2834)
    Bash (1), Crystal (80), JavaScript (311), Kotlin (316), Lua (306), Postscript (352), Python (451), Ruby (439), Rust (434), Scala (144).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1168)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (384), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (390).
#### 4. Ulrich Rieke (992)
    Awk (3), C (2), C++ (352), Haskell (390), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (226).
#### 5. Ali Moradi (747)
    APL (1), Ada (14), C (55), C++ (67), D (58), Go (17), Haskell (10), Java (60), Lisp (20), Lua (90), Modula 3 (106), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (38), Ruby (34), Scheme (4), Standard ML (6), Zig (6).
#### 6. Lubos Kolouch (674)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (608), Ruby (1), VBA (1).
#### 7. David Ferrone (474)
    C (115), JavaScript (109), Python (110), R (19), Rust (121).
#### 8. PokGoPun (453)
    Dart (24), Go (268), Python (161).
#### 9. Stuart Little (436)
...
#### 18. Conor Hoekstra (203)
    APL (66), BQN (103), C++ (2), CUDA (1), Haskell (6), J (8), Kap (4), Python (4), Rust (1), Uiua (8).
#### 19. Packy Anderson (185)
    Elixir (54), Java (8), Python (123).
#### 20. BarrOff (143)
    Ada (1), Awk (1), BQN (9), D (3), GP (2), Julia (83), Nim (36), Pascal (5), V (3).
#### 21. Steven Wilson (127)
    Haskell (1), JavaScript (13), Python (112), Rust (1).
#### 22. Archar Gelod (124)
    Nim (124).
...
#### 111. Joelle Maslak (2)
    Go (2).
#### 112. Mariano Ortega (2)
    Java (2).
#### 113. Mark Anderson (2)
    PowerShell (2).
#### 114. Mark Senn (2)
    Wolfram (2).
#### 115. Richard Loveland (2)
    K (2).
#### 116. Ruth Holloway (2)
    COBOL (2).
#### 117. Tejas (2)
...
#### 123. Chazzka (1)
    Coconut (1).
#### 124. Christian Jaeger (1)
    Haskell (1).
#### 125. Daniel Aberger (1)
    Go (1).
#### 126. Darren Bottin (1)
    Prolog (1).
#### 127. David Schwartz (1)
    Python (1).
#### 128. Gurunandan Bhat (1)
    Go (1).
#### 129. Jaldhar H. Vyas (1)
    C++ (1).
#### 130. Maxim Kolodyazhny (1)
    Elixir (1).
#### 131. Robbie Hatley (1)
    C (1).
#### 132. Roman Kotelnikov (1)
    J (1).
#### 133. Stephen G. Lynn (1)
    Julia (1).
...
***
    ...
    Python (3369), Rust (852), C (833), Ruby (776), Haskell (749), Lua (690), C++ (591), JavaScript (536), Go (463), BQN (416), Java (406), Postscript (371), Kotlin (369), Julia (324), PostgreSQL (257), Scala (226), Clojure (202), Bash (200), Nim (198), Node.js (196), Awk (190), Prolog (184), APL (165), Pascal (164), Tcl (152), Modula 3 (106), BASIC (100), R (100), Forth (98), D (95), Bc (84), Crystal (83), Elixir (75), Lisp (75), Excel VBA (63), Scheme (62), PHP (51), Oberon (47), Swift (41), Dart (40), Ada (38), Uiua (38), Befunge-93 (35), Fortran (33), OCaml (33), J (26), Erlang (24), SQL (24), COBOL (20), F# (20), Ring (20), C Shell (19), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), Zig (11), C# (10), Hy (10), Racket (10), Smalltalk (9), Fennel (8), Brainfuck (6), Standard ML (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), K (4), Kap (4), Nu (4), CESIL (3), Fish (3), Gembase (3), Janet (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), CUDA (1), Chef (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-309.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/vinod-k/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/jaldhar-h-vyas/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/jaldhar-h-vyas/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-309/jaldhar-h-vyas/raku/ch-2.sh)]
[[**BLOG #1**](https://www.braincells.com/perl/2025/02/perl_weekly_challenge_week_309.html)]
