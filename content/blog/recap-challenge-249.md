...
#### 3. Paulo Custodio (1020)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (264), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (655)
...
#### 6. Lubos Kolouch (554)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (488), Ruby (1), VBA (1).
#### 7. Stuart Little (436)
...
#### 12. Eric Cheung (258)
    Excel VBA (63), Python (195).
#### 13. PokGoPun (214)
    Dart (24), Go (148), Python (42).
#### 14. Luca Ferrari (207)
    PostgreSQL (183), Python (24).
#### 15. Adam Russell (202)
...
#### 36. Bruce Gray (26)
    C (3), Dart (2), F# (6), Go (2), JavaScript (2), Julia (2), Python (2), Rust (2), SVG (1), WebAssembly (2), YaBasic (2).
#### 37. Thomas Kohler (26)
    Python (26).
...
***
    ...
    Python (2355), Ruby (639), C (617), Haskell (617), Lua (560), Rust (515), C++ (452), JavaScript (334), BQN (321), Go (314), Java (284), Postscript (256), Kotlin (254), Julia (245), Clojure (200), Node.js (196), Awk (190), PostgreSQL (183), Nim (156), Pascal (155), Prolog (155), Bash (144), APL (138), Scala (102), Tcl (102), BASIC (100), Forth (98), Bc (84), D (84), R (81), Lisp (66), Excel VBA (63), Scheme (58), Modula 3 (52), Oberon (45), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), OCaml (31), SQL (24), Erlang (22), Ring (20), C Shell (19), COBOL (18), F# (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), J (11), Smalltalk (9), Fennel (8), Uiua (8), Brainfuck (6), Zig (5), Emacs Lisp (4), Factor (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Elixir (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2440), Jaldhar H. Vyas (2330), Roger Bell_West (2232), Luca Ferrari (2108), Arne Sommer (1792), Flavio Poletti (1716), Athanasius (1554), Ulrich Rieke (1402), Colin Crain (1336), Adam Russell (1172), Dave Jacoby (1132), Lubos Kolouch (1124), E. Choroba (1084), Paulo Custodio (992), Jorg Sommrey (954), W. Luis Mochan (952), James Smith (866), Simon Green (854), Duncan C. White (794), Cheok-Yin Fung (792), Mark Anderson (792), Mohammad Sajid Anwar (718), Peter Campbell Smith (664), Stuart Little (644), Feng Chang (622), Jan Krnavek (610), Abigail (574), Robert DiCicco (570), Niels van Dijke (564), Simon Proctor (542), Bruce Gray (532), Bob Lied (482), Javier Luque (460), Ruben Westerberg (452), Thomas Kohler (434), Stephen G. Lynn (424), Ali Moradi (418), Ryan Thompson (390), Wanderdoc (386), Matthew Neleigh (366), Robert Ransbottom (360), Pete Houston (360), Robbie Hatley (336), David Ferrone (314), Joelle Maslak (282), Peter Meszaros (268), Andrezgz (252), Steven Wilson (242), Packy Anderson (230), Matthias Muth (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), BarrOff (212), Reinier Maliepaard (200), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Solathian (188), Marton Polgar (178), Avery Adams (176), Kevin Colyer (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Kjetil Skotheim (116), Humberto Massa (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/paulo-custodio/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/jaldhar-h-vyas/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/jaldhar-h-vyas/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-249/jaldhar-h-vyas/raku/ch-2.raku)]
[[**BLOG #1**](https://www.braincells.com/perl/2024/01/perl_weekly_challenge_week_249.html)]
