...
#### 1) Ulrich Rieke: C++ (19), Haskell (20).
...
#### 7) Wanderdoc: R (11).
#### 8) Adam Russell: C++ (8), Prolog (2).
#### 9) Mohammad S Anwar: Java (1), Swift (9).
#### 10) Burkhard Nickels: Python (8).
#### 11) Leo Manfredi: Bash (2), Python (6).
#### 12) Sangeet Kar: Python (8).
#### 13) Dave Jacoby: HTML (1), Node (3), Rust (2).
#### 14) Arne Sommer: Bash (1), Node (1), PHP (1), Python (1), Ruby (1).
#### 15) Myoungjin Jeon: Haskell (3), Lisp (2).
#### 16) Kivanc Yazan: Python (4).
#### 17) Shawak: Ruby (4).
#### 18) Yet Ebreo: Python (2), Ruby (2).
#### 19) Cheok-Yin Fung: Lisp (3).
#### 20) Duncan C. White: Postscript (3).
#### 21) Jonas Berlin: Rust (3).
#### 22) Rage311: Rust (3).
...
#### **Adam Russell** moved up to the rank **#010**.
#### **Mohammad S Anwar** moved up to the rank **#012**.
#### **Luca Ferrari** moved up to the rank **#017**.
#### **Ulrich Rieke** moved up to the rank **#019**.
#### **Noud Aldenhoven** moved up to the rank **#021**.
#### **Mark Anderson** moved up to the rank **#024**.

<br>

#### 1) Laurent Rosenfeld (**814**)
#### 2) Jaldhar H. Vyas (**612**)
#### 3) Roger Bell_West (**490**)
#### 4) Arne Sommer (**480**)
...
#### 12) Mohammad S Anwar (**284**)
#### 13) Simon Proctor (**280**)
#### 14) Ryan Thompson (**278**)
#### 15) Dave Jacoby (**276**)
...
#### 19) Ulrich Rieke (**210**)
#### 20) Yet Ebreo (**206**)
#### 21) Noud Aldenhoven (**180**)
#### 22) Kevin Colyer (**176**)
#### 23) Kian-Meng Ang (**162**)
#### 24) Mark Anderson (**138**)
#### 25) Steven Wilson (**138**)
#### 26) Duane Powell (**136**)
#### 27) Markus Holzer (**134**)
#### 28) Cheok-Yin Fung (**132**)
#### 29) Wanderdoc (**130**)
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-072/arne-sommer/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-072/jeongoon/perl/ch-1.pl)]
