...
#### 9. Lubos Kolouch (277)
    Bash (6), C++ (1), Go (2), Java (5), JavaScript (1), PHP (9), Python (251), Ruby (1), VBA (1).
...
#### 21. Mohammad Meraj Zia (81)
    Java (73), Kotlin (8).
#### 22. Cheok-Yin Fung (74)
    Awk (3), Bash (6), Befunge-93 (1), C (1), C++ (1), Dart (4), Java (16), JavaScript (1), Julia (13), Lisp (11), Node (1), Node.js (3), Python (4), Smalltalk (9).
#### 23. Richard Park (73)
