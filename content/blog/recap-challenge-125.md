...
#### 1. Abigail (717)
    Awk (72), Bash (62), Basic (9), Bc (18), Befunge (22), Brainfuck (1), C (76), C Shell (7), COBOL (7), Chef (1), Erlang (6), Forth (7), Fortran (9), Go (18), Java (17), Lua (62), M4 (2), MMIX (3), Macro Processor (4), Mumps (1), Node.js (81), OCaml (6), Ook (1), PHP (6), Pascal (20), Postscript (5), Python (67), R (17), Rexx (6), Ruby (62), SQL (11), Scheme (13), Sed (5), Tcl (13).
#### 2. Stuart Little (412)
