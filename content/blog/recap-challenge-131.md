...
#### 1. Abigail (751)
    Awk (80), Bash (65), Basic (9), Bc (18), Befunge (22), Brainfuck (1), C (82), C Shell (7), COBOL (7), Chef (1), Erlang (6), Forth (7), Fortran (9), Go (18), Java (17), Lua (67), M4 (2), MMIX (3), Macro Processor (4), Mumps (1), Node.js (86), OCaml (6), Ook (1), PHP (6), Pascal (20), Postscript (5), Python (71), R (17), Rexx (6), Ruby (65), SQL (11), Scheme (13), Sed (5), Tcl (13).
#### 2. Stuart Little (436)
