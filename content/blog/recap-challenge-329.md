...
#### 1. Roger Bell_West (3148)
    Bash (1), Crystal (112), JavaScript (343), Kotlin (348), Lua (338), Postscript (386), Python (483), Ruby (471), Rust (474), Scala (176), Typst (16).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1206)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (422), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (390).
#### 4. Ulrich Rieke (1112)
    Awk (3), C (2), C++ (392), Haskell (430), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (266).
#### 5. Ali Moradi (843)
    APL (1), Ada (14), C (55), C++ (67), D (62), Erlang (16), Gleam (2), Go (23), Haskell (10), Java (96), Lisp (20), Lua (98), Modula 3 (128), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (38), Ruby (34), Rust (2), Scheme (4), Standard ML (6), Zig (6).
#### 6. Lubos Kolouch (714)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (648), Ruby (1), VBA (1).
#### 7. PokGoPun (533)
    Dart (24), Go (308), Python (201).
#### 8. David Ferrone (474)
    C (115), JavaScript (109), Python (110), R (19), Rust (121).
#### 9. Luca Ferrari (463)
    Java (82), PostgreSQL (271), Python (110).
#### 10. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 11. Eric Cheung (416)
    Excel VBA (63), Python (353).
...
#### 19. Packy Anderson (237)
    Elixir (80), Java (8), Python (149).
...
#### 44. HVukman (27)
    F# (3), J (1), K (10), Lua (3), PicoLisp (8), Retro (2).
#### 45. Shawn Wagner (27)
...
***
    ...
    Python (3654), Rust (942), C (875), Ruby (808), Haskell (791), Lua (733), C++ (631), JavaScript (568), Go (511), Java (456), BQN (452), Postscript (405), Kotlin (401), Julia (324), PostgreSQL (271), Scala (258), Prolog (224), Clojure (202), Bash (200), Nim (198), Node.js (196), Tcl (192), Awk (190), APL (167), Pascal (164), Modula 3 (128), Crystal (115), Elixir (101), BASIC (100), R (100), D (99), Forth (98), Bc (84), Lisp (75), Excel VBA (63), Scheme (62), Uiua (60), PHP (51), Oberon (47), Dart (46), Swift (41), Erlang (40), Ada (38), Befunge-93 (35), Fortran (33), OCaml (33), J (27), SQL (24), F# (23), COBOL (20), Ring (20), C Shell (19), M4 (18), Rexx (17), Sed (16), Typst (16), Elm (15), K (14), MMIX (14), PowerShell (13), Nelua (12), Zig (11), C# (10), Hy (10), Racket (10), Smalltalk (9), Fennel (8), PicoLisp (8), Brainfuck (6), Standard ML (6), TypeScript (6), WebAssembly (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), Kap (4), Nu (4), CESIL (3), Fish (3), Gembase (3), Janet (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), Gleam (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), Retro (2), Wolfram (2), YaBasic (2), Bourne Shell (1), CUDA (1), Chef (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (3254), Jaldhar H. Vyas (3130), Roger Bell_West (3000), Laurent Rosenfeld (2906), Arne Sommer (2272), Athanasius (2150), Ulrich Rieke (2000), Flavio Poletti (1716), Lubos Kolouch (1492), Dave Jacoby (1488), Adam Russell (1446), Jorg Sommrey (1438), W. Luis Mochan (1432), E. Choroba (1408), Colin Crain (1336), Paulo Custodio (1312), Simon Green (1220), Peter Campbell Smith (1138), Mark Anderson (1094), Thomas Kohler (1026), Feng Chang (942), Jan Krnavek (904), Cheok-Yin Fung (892), James Smith (882), Ali Moradi (872), Bob Lied (824), Packy Anderson (812), Niels van Dijke (796), Duncan C. White (794), Robbie Hatley (790), Mohammad Sajid Anwar (718), Bruce Gray (674), Robert Ransbottom (660), Wanderdoc (652), Stuart Little (644), David Ferrone (636), Matthias Muth (620), Simon Proctor (582), Peter Meszaros (576), Abigail (574), Robert DiCicco (574), Matthew Neleigh (562), Stephen G. Lynn (478), Javier Luque (460), BarrOff (452), Ruben Westerberg (452), Ryan Thompson (442), Pete Houston (360), Kjetil Skotheim (328), Joelle Maslak (314), Reinier Maliepaard (298), Andrew Shitov (294), Steven Wilson (284), Andrezgz (264), Yet Ebreo (222), Alexander Pankoff (220), Walt Mankowski (210), Markus Holzer (198), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Nelo Tovar (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Mariano Spadaccini (142), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Humberto Massa (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Santiago Leyva (118), Julio de Castro (116), Andreas Mahnke (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/mahnkong/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-329.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-329/wanderdoc/perl/ch-1.pl)]
