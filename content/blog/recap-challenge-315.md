...
#### 1. Roger Bell_West (2942)
    Bash (1), Crystal (92), JavaScript (323), Kotlin (328), Lua (318), Postscript (364), Python (463), Ruby (451), Rust (446), Scala (156).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1180)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (396), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (390).
#### 4. Ulrich Rieke (1028)
    Awk (3), C (2), C++ (364), Haskell (402), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (238).
#### 5. Ali Moradi (769)
    APL (1), Ada (14), C (55), C++ (67), D (60), Go (17), Haskell (10), Java (72), Lisp (20), Lua (90), Modula 3 (114), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (38), Ruby (34), Scheme (4), Standard ML (6), Zig (6).
#### 6. Lubos Kolouch (686)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (620), Ruby (1), VBA (1).
#### 7. PokGoPun (477)
    Dart (24), Go (280), Python (173).
#### 8. David Ferrone (474)
...
#### 17. Adam Russell (225)
    C++ (26), Fortran (3), Java (16), JavaScript (6), Nuweb (3), Prolog (163), Python (2), R (6).
#### 18. Conor Hoekstra (219)
    APL (66), BQN (115), C++ (2), CUDA (1), Haskell (6), J (8), Kap (4), Python (4), Rust (1), Uiua (12).
#### 19. Packy Anderson (185)
    Elixir (54), Java (8), Python (123).
#### 20. BarrOff (143)
    Ada (1), Awk (1), BQN (9), D (3), GP (2), Julia (83), Nim (36), Pascal (5), V (3).
#### 21. Steven Wilson (139)
    Haskell (1), JavaScript (13), Python (124), Rust (1).
#### 22. Archar Gelod (124)
    Nim (124).
...
***
    ...
    Python (3455), Rust (878), C (845), Ruby (788), Haskell (763), Lua (702), C++ (603), JavaScript (548), Go (476), BQN (428), Java (420), Postscript (383), Kotlin (381), Julia (324), PostgreSQL (259), Scala (238), Clojure (202), Bash (200), Prolog (200), Nim (198), Node.js (196), Awk (190), APL (167), Pascal (164), Tcl (164), Modula 3 (114), BASIC (100), R (100), Forth (98), D (97), Crystal (95), Bc (84), Elixir (75), Lisp (75), Excel VBA (63), Scheme (62), PHP (51), Oberon (47), Dart (46), Uiua (44), Swift (41), Ada (38), Befunge-93 (35), Fortran (33), OCaml (33), J (26), Erlang (24), SQL (24), COBOL (20), F# (20), Ring (20), C Shell (19), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), Zig (11), C# (10), Hy (10), Racket (10), Smalltalk (9), Fennel (8), Brainfuck (6), Standard ML (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), K (4), Kap (4), Nu (4), WebAssembly (4), CESIL (3), Fish (3), Gembase (3), Janet (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), Wolfram (2), YaBasic (2), Bourne Shell (1), CUDA (1), Chef (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (3066), Jaldhar H. Vyas (2990), Laurent Rosenfeld (2906), Roger Bell_West (2880), Arne Sommer (2188), Athanasius (2050), Lubos Kolouch (1990), Ulrich Rieke (1888), Flavio Poletti (1716), Dave Jacoby (1434), Jorg Sommrey (1354), E. Choroba (1352), W. Luis Mochan (1348), Adam Russell (1336), Colin Crain (1336), Paulo Custodio (1256), Simon Green (1152), Peter Campbell Smith (1054), Mark Anderson (1038), Thomas Kohler (922), Cheok-Yin Fung (892), Feng Chang (886), James Smith (882), Jan Krnavek (848), Duncan C. White (794), Ali Moradi (788), Bob Lied (770), Niels van Dijke (740), Mohammad Sajid Anwar (718), Robbie Hatley (718), Packy Anderson (682), Bruce Gray (674), Stuart Little (644), Robert Ransbottom (604), Wanderdoc (596), David Ferrone (580), Abigail (574), Robert DiCicco (574), Matthew Neleigh (562), Simon Proctor (560), Matthias Muth (536), Peter Meszaros (520), Stephen G. Lynn (478), Javier Luque (460), Ruben Westerberg (452), Ryan Thompson (442), BarrOff (416), Reinier Maliepaard (390), Pete Houston (360), Joelle Maslak (314), Kjetil Skotheim (292), Steven Wilson (278), Andrezgz (264), Andrew Shitov (254), Yet Ebreo (222), Alexander Pankoff (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Nelo Tovar (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Mariano Spadaccini (142), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Santiago Leyva (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/bob-lied/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/kjetillll/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-315.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/paulo-custodio/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/arne-sommer/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-315/athanasius/perl/ch-1.pl)]
