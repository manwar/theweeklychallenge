...
#### 1. Abigail (678)
    Awk (66), BASIC (8), Bash (59), Bc (18), Befunge-93 (20), Brainfuck (1), C (70), C Shell (6), COBOL (6), Chef (1), Erlang (5), Forth (6), Fortran (8), Go (21), Java (20), Lua (56), M4 (5), MMIX (2), Mumps (1), Node.js (75), OCaml (5), Ook (1), PHP (5), Pascal (23), Postscript (4), Python (60), R (19), Rexx (5), Ruby (56), SQL (10), Scheme (17), Sed (5), Tcl (14).
#### 2. Paulo Custodio (593)
    Ada (20), Awk (26), BASIC (42), Bc (15), Brainfuck (4), C (87), C++ (56), D (13), Forth (40), Fortran (7), Lua (36), Pascal (5), Python (242).
#### 3. Stuart Little (380)
    Haskell (242), Lua (74), Node.js (30), Python (34).
#### 4. Lubos Kolouch (271)
    Bash (1), C++ (1), Go (5), Java (23), JavaScript (1), Kotlin (2), PHP (1), Python (235), Ruby (1), VBA (1).
#### 5. Roger Bell_West (244)
    Bash (1), Postscript (5), Python (91), Ruby (79), Rust (68).
#### 6. AhmetEmre (226)
    BQN (226).
#### 7. Ulrich Rieke (143)
    Awk (1), C (2), C++ (61), Haskell (72), Java (1), Lisp (6).
...
#### 25. Orestis Zekai (16)
    Python (16).
#### 26. Cristina Heredia (15)
    Python (15).
#### 27. Pete Houston (15)
    Awk (7), Bash (1), C (2), Fortran (1), Lua (2), Python (2).
#### 28. Dave Jacoby (13)
...
#### 31. Wanderdoc (12)
    R (12).
#### 32. Lucas Ransan (10)
    Miranda (2), Myrddin (2), Nix (2), Odin (2), Zig (2).
#### 33. Jonas Berlin (9)
    Rust (9).
#### 34. Kang-min Liu (9)
...
#### 40. Shawak (8)
    Ruby (8).
#### 41. Alexander Pankoff (7)
    Haskell (7).
#### 42. James Smith (7)
    CESIL (3), JavaScript (1), PHP (2), Python (1).
#### 43. Eric Cheung (6)
    Excel VBA (6).
#### 44. Henry Wong (6)
    PHP (6).
...
#### 54. Gabor Szabo (3)
    Crystal (3).
#### 55. Guillermo Ramos (3)
    Go (3).
#### 56. Rage311 (3)
    Rust (3).
#### 57. Ali Moradi (2)
    C (2).
#### 58. Bartosz Jarzyna (2)
    PHP (2).
#### 59. Ben Davies (2)
    Idris (2).
#### 60. Daniel Mita (2)
...
***
    ...
    Python (862), Haskell (365), BQN (239), C (208), Lua (207), Ruby (158), C++ (150), Rust (120), Node.js (117), Awk (108), Nim (108), Java (89), Clojure (88), APL (80), JavaScript (80), Go (73), Bash (71), BASIC (50), Prolog (47), Scala (47), Forth (46), Lisp (40), Bc (34), Pascal (32), R (31), Tcl (25), Ada (20), Befunge-93 (20), D (19), PHP (18), Swift (18), Fortran (17), Scheme (17), Elm (15), Kotlin (15), OCaml (13), Postscript (12), SQL (10), Dart (8), Julia (8), Smalltalk (8), Erlang (7), C Shell (6), COBOL (6), Excel VBA (6), Brainfuck (5), M4 (5), Rexx (5), Sed (5), CESIL (3), Crystal (3), Gembase (3), Janet (3), HTML (2), Haxe (2), Idris (2), J (2), MMIX (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), Zig (2), C# (1), Chef (1), Fish (1), GNAT (1), Mumps (1), Ook (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1252), Jaldhar H. Vyas (1120), Roger Bell_West (972), Arne Sommer (898), Colin Crain (794), Lubos Kolouch (724), Athanasius (676), Adam Russell (616), Stuart Little (588), E. Choroba (570), Dave Jacoby (536), Ulrich Rieke (528), Paulo Custodio (484), Luca Ferrari (468), Mohammad Sajid Anwar (468), Javier Luque (460), Ruben Westerberg (452), Jorg Sommrey (448), Duncan C. White (426), Simon Proctor (426), Flavio Poletti (394), Cheok-Yin Fung (364), Abigail (334), Mark Anderson (320), Ryan Thompson (294), Simon Green (292), Wanderdoc (292), James Smith (286), Joelle Maslak (274), Feng Chang (254), Niels van Dijke (228), Andrezgz (222), Yet Ebreo (222), Pete Houston (220), Myoungjin Jeon (192), Markus Holzer (190), Noud Aldenhoven (188), Jan Krnavek (188), W. Luis Mochan (186), Kevin Colyer (176), Aaron Smith (174), Steven Wilson (164), Kian-Meng Ang (162), Walt Mankowski (162), Andrew Shitov (160), Duane Powell (156), Shahed Nooshmand (140), Dave Cross (120), Kang-min Liu (118), Julio de Castro (116), Gustavo Chaves (112), Cristina Heredia (110), Saif Ahmed (110), Bob Lied (108), Joan Mimosinnet (108), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-121.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/perlboy1967/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/simon-proctor/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/colin-crain/perl/ch-1.pl)]
...
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/jaldhar-h-vyas/raku/ch-1.sh)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-121/jaldhar-h-vyas/raku/ch-2.raku)]
