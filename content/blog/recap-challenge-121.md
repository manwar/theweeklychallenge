...
#### 1. Abigail (633)
    Awk (66), Bash (57), Basic (8), Bc (15), Befunge (20), Brainfuck (1), C (70), C Shell (6), COBOL (6), Chef (1), Erlang (5), Forth (6), Fortran (8), Go (14), Java (13), Lua (56), M4 (1), MMIX (2), Macro Processor (4), Mumps (1), Node.js (75), OCaml (5), Ook (1), PHP (5), Pascal (16), Postscript (4), Python (60), R (12), Rexx (5), Ruby (56), SQL (10), Scheme (10), Sed (5), Tcl (9).
#### 2. Stuart Little (378)
    Haskell (242), Lua (72), Node.js (30), Python (34).
#### 3. Paulo Custodio (349)
    Ada (19), Awk (25), Basic (41), Bc (14), Brainfuck (1), C (55), C++ (55), D (12), Forth (39), Fortran (6), Lua (35), Pascal (4), Python (43).
#### 4. Roger Bell_West (244)
