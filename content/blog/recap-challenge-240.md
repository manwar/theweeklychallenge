...
#### 5. Ali Moradi (501)
    APL (1), Ada (14), C (43), C++ (51), D (46), Go (7), Haskell (8), Java (10), Lisp (20), Lua (68), Modula 3 (46), Nelua (12), Nim (24), OCaml (6), Oberon (39), Pascal (60), Python (32), Ruby (14).
#### 6. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 7. Lubos Kolouch (400)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (361), Ruby (1), VBA (1).
...
#### 26. Stephen G Lynn (46)
    Julia (46).
#### 27. Steven Wilson (46)
    Haskell (1), JavaScript (13), Python (31), Rust (1).
#### 28. Nuno Vieira (44)
    JavaScript (44).
...
#### 75. Ian Rifkin (4)
    Python (4).
#### 76. Julien Fiegehenn (4)
    TypeScript (4).
#### 77. Karishma Rajput (4)
    C (1), C++ (1), JavaScript (1), Node.js (1).
#### 78. Kivanc Yazan (4)
    Python (4).
#### 79. Kjetil Skotheim (4)
    Scala (4).
#### 80. Kueppo Wesley (4)
    Node.js (4).
#### 81. Macy TY (4)
    JavaScript (4).
#### 82. Magnus Markling (4)
    Uiua (4).
#### 83. Mohammad Foda (4)
    Haxe (2), Nim (2).
#### 84. Philip Hood (4)
