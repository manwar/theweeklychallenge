...
<div class="container">
    <div class="row g-4 justify-content-center">
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/app.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/info.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/challenge.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/members.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/champ.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/year.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/all.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/guests.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/guest_year.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/langs.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/comm.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
        <div class="col-auto mb-4 p-2 text-center">
            <img src="/images/blog/app/menu.jpg" class="img-fluid"
                style="width: 100%; max-width: 300px;"/>
        </div>
    </div>
</div>
