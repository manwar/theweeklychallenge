...
In this blog post, I am talking about `Strategy` design pattern in `Perl`. The example used in the post is taken from my book, [**Design Patterns in Modern Perl**](https://perlschool.com/books/design-patterns).
