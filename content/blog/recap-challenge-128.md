...
The total contributions in the week is `64`. Well done **Team PWC**. I would also like to thanks `Raku` contributors for catching up.
...
#### 1. Abigail (741)
    Awk (77), Bash (64), Basic (9), Bc (18), Befunge (22), Brainfuck (1), C (80), C Shell (7), COBOL (7), Chef (1), Erlang (6), Forth (7), Fortran (9), Go (18), Java (17), Lua (66), M4 (2), MMIX (3), Macro Processor (4), Mumps (1), Node.js (85), OCaml (6), Ook (1), PHP (6), Pascal (20), Postscript (5), Python (70), R (17), Rexx (6), Ruby (64), SQL (11), Scheme (13), Sed (5), Tcl (13).
#### 2. Stuart Little (436)
...
#### 7. Tyler Wardhaugh (141)
    Clojure (93), Lua (36), Python (12).
#### 8. Myoungjin Jeon (85)
...
#### 20. Mohammad S Anwar (19)
    Java (1), Swift (18).
#### 21. Cristina Heredia (17)
    Python (17).
#### 22. Orestis Zekai (16)
    Python (16).
#### 23. Pete Houston (16)
...
#### 55. Tejas (2)
    C++ (2).
#### 56. Alexander Pankoff (1)
    Haskell (1).
#### 57. Bob Lied (1)
    C (1).
#### 58. Bruce Gray (1)
    SVG (1).
#### 59. Christian Jaeger (1)
    Haskell (1).
#### 60. Darren Bottin (1)
    Prolog (1).
#### 61. David Schwartz (1)
