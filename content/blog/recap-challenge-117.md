...
#### 1. Abigail (508)
    Awk (56), Bash (47), Basic (7), Bc (10), Befunge (15), Brainfuck (1), C (60), C Shell (5), COBOL (5), Chef (1), Erlang (4), Forth (5), Fortran (7), Go (8), Java (7), Lua (46), MMIX (1), Macro Processor (4), Mumps (1), Node.js (65), OCaml (4), Ook (1), PHP (4), Pascal (11), Postscript (3), Python (50), R (7), Rexx (4), Ruby (46), SQL (9), Scheme (6), Sed (4), Tcl (4).
#### 2. Stuart Little (282)
    Haskell (234), Node.js (22), Python (26).
#### 3. Paulo Custodio (238)
    Ada (14), Awk (20), Basic (36), Bc (2), C (32), C++ (32), Forth (34), Lua (30), Python (38).
#### 4. Roger Bell_West (222)
    Bash (1), Postscript (2), Python (85), Ruby (73), Rust (61).
#### 5. Ulrich Rieke (136)
    Awk (1), C (2), C++ (57), Haskell (70), Java (1), Lisp (5).
#### 6. Tyler Wardhaugh (130)
...
#### 50. Tejas (2)
    C++ (2).
#### 51. Alexander Pankoff (1)
    Haskell (1).
#### 52. Bob Lied (1)
    C (1).
#### 53. Christian Jaeger (1)
    Haskell (1).
#### 54. Darren Bottin (1)
    Prolog (1).
#### 55. David Schwartz (1)
