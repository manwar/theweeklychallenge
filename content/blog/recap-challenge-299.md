...
The total contributions in the week is `66`. Well done **Team PWC**. I would also like to thank `Raku` contributors for catching up.
...
#### 1. Roger Bell_West (2654)
    Bash (1), Crystal (60), JavaScript (291), Kotlin (296), Lua (286), Postscript (332), Python (431), Ruby (419), Rust (414), Scala (124).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1148)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (364), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (390).
#### 4. Ulrich Rieke (932)
    Awk (3), C (2), C++ (332), Haskell (370), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (206).
#### 5. Ali Moradi (715)
...
#### 6. Lubos Kolouch (654)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (588), Ruby (1), VBA (1).
#### 7. David Ferrone (474)
...
#### 19. Conor Hoekstra (170)
    APL (63), BQN (85), C++ (2), Haskell (6), J (8), Python (3), Rust (1), Uiua (2).
#### 20. BarrOff (130)
    Ada (1), Awk (1), BQN (9), D (3), GP (2), Julia (77), Nim (31), Pascal (3), V (3).
#### 21. Archar Gelod (124)
    Nim (124).
...
#### 40. Peter Meszaros (32)
    Tcl (32).
#### 41. Dave Jacoby (27)
    HTML (1), Node.js (14), Python (10), Rust (2).
#### 42. Shawn Wagner (27)
...
***
    ...
    Python (3244), C (812), Rust (812), Ruby (756), Haskell (729), Lua (670), C++ (571), JavaScript (516), Go (443), BQN (398), Java (390), Postscript (351), Kotlin (349), Julia (314), PostgreSQL (253), Scala (206), Clojure (202), Bash (200), Node.js (196), Nim (193), Awk (190), Prolog (176), Pascal (162), APL (156), Tcl (134), BASIC (100), R (100), Forth (98), D (95), Modula 3 (94), Bc (84), Elixir (75), Lisp (75), Crystal (63), Excel VBA (63), Scheme (60), PHP (51), Oberon (47), Swift (41), Dart (40), Ada (38), Befunge-93 (35), Fortran (33), OCaml (33), Uiua (32), J (26), Erlang (24), SQL (24), COBOL (20), Ring (20), C Shell (19), F# (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), C# (10), Hy (10), Racket (10), Smalltalk (9), Fennel (8), Zig (7), Brainfuck (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), K (4), Nu (4), Standard ML (4), CESIL (3), Gembase (3), Janet (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (2962), Laurent Rosenfeld (2906), Jaldhar H. Vyas (2830), Roger Bell_West (2720), Arne Sommer (2092), Athanasius (1930), Lubos Kolouch (1894), Ulrich Rieke (1760), Flavio Poletti (1716), Dave Jacoby (1380), Colin Crain (1336), E. Choroba (1288), Adam Russell (1282), Jorg Sommrey (1258), W. Luis Mochan (1252), Paulo Custodio (1192), Simon Green (1090), Mark Anderson (978), Peter Campbell Smith (964), Cheok-Yin Fung (892), James Smith (882), Feng Chang (822), Thomas Kohler (798), Jan Krnavek (796), Duncan C. White (794), Mohammad Sajid Anwar (718), Bob Lied (706), Niels van Dijke (704), Ali Moradi (698), Packy Anderson (682), Bruce Gray (674), Stuart Little (644), Robbie Hatley (622), Abigail (574), Robert DiCicco (574), Simon Proctor (560), Matthew Neleigh (554), Robert Ransbottom (540), Wanderdoc (534), David Ferrone (516), Stephen G. Lynn (478), Matthias Muth (462), Javier Luque (460), Peter Meszaros (460), Ruben Westerberg (452), Ryan Thompson (430), Reinier Maliepaard (390), BarrOff (378), Pete Houston (360), Joelle Maslak (314), Andrezgz (264), Andrew Shitov (254), Kjetil Skotheim (248), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Nelo Tovar (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Mariano Spadaccini (134), Andinus (132), Pip Stuart (132), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/deadmarshal/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/jo-37/perl/ch-1.pl)]
...
[[**BLOG #2**](https://github.sommrey.de/the-bears-den/2025/01/09/ch-299.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-299.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-299/robbie-hatley/perl/ch-1.pl)]
