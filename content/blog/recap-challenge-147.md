...
#### 1. Abigail (1176)
    Awk (106), Bash (94), Basic (14), Bc (46), Befunge (27), Brainfuck (3), C (108), C Shell (12), COBOL (11), Chef (1), Erlang (12), Forth (11), Fortran (13), Go (53), Java (50), Lua (94), M4 (7), MMIX (7), Macro Processor (4), Mumps (1), Node.js (113), OCaml (10), Ook (1), PHP (10), Pascal (53), Postscript (9), Python (98), R (48), Rexx (10), Ruby (92), SQL (15), Scheme (47), Sed (9), Tcl (47).
...
#### 6. Laurent Rosenfeld (184)
    Awk (11), Bash (2), Bc (2), Bourne Shell (1), C (11), C++ (1), D (8), Dart (3), Gembase (3), Go (7), IO (1), Java (2), Julia (14), Kotlin (5), Lua (7), Nim (4), Pascal (5), Python (28), Ring (6), Ruby (12), Rust (9), Scala (38), Sed (1), Tcl (1), Visual Basic (1), Zig (1).
#### 7. Tyler Wardhaugh (172)
...
#### 13. Cheok-Yin Fung (57)
    Awk (3), Bash (6), Befunge (1), C++ (1), Java (13), JavaScript (1), Julia (7), Lisp (11), Node.js (2), Python (3), Smalltalk (9).
#### 14. Conor Hoekstra (50)
    APL (31), BQN (9), C++ (1), Haskell (4), J (5).
#### 15. Mohammad Meraj Zia (50)
    Java (42), Kotlin (8).
#### 16. Mohammad S Anwar (45)
