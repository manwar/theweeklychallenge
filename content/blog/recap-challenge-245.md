...
#### 3. Paulo Custodio (1012)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (256), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (640)
...
#### 6. Lubos Kolouch (546)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (480), Ruby (1), VBA (1).
#### 7. Stuart Little (436)
...
#### 12. Eric Cheung (250)
    Excel VBA (63), Python (187).
#### 13. Adam Russell (202)
    C++ (26), Fortran (3), Java (16), JavaScript (6), Nuweb (3), Prolog (142), R (6).
#### 14. PokGoPun (198)
    Dart (24), Go (140), Python (34).
#### 15. Luca Ferrari (191)
    PostgreSQL (175), Python (16).
#### 16. Simon Green (159)
    Python (159).
...
#### 31. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 32. BarrOff (38)
    Awk (1), GP (2), Julia (21), Nim (13), V (1).
#### 33. Andrew Shitov (34)
...
#### 37. Andreas Voegele (22)
    Kotlin (22).
#### 38. Alexander Pankoff (21)
    Haskell (21).
#### 39. Cristina Heredia (21)
    Python (21).
#### 40. Ian Goodnight (21)
...
#### 69. Joao Felipe (6)
    APL (4), Python (2).
#### 70. Magnus Markling (6)
    Uiua (6).
#### 71. Michael DiCicco (6)
    Java (3), Python (3).
#### 72. W. Luis Mochan (6)
...
***
    ...
    Python (2293), Ruby (630), Haskell (612), C (609), Lua (552), Rust (502), C++ (447), JavaScript (326), BQN (321), Go (306), Java (284), Postscript (248), Kotlin (246), Julia (243), Clojure (200), Node.js (196), Awk (190), PostgreSQL (175), Nim (155), Pascal (155), Prolog (155), APL (138), Bash (137), Tcl (102), BASIC (100), Forth (98), Scala (94), Bc (84), D (84), R (81), Lisp (66), Excel VBA (63), Scheme (58), Modula 3 (52), Oberon (45), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Fortran (33), OCaml (31), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), F# (16), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), J (11), Smalltalk (9), Fennel (8), Uiua (8), Brainfuck (6), Zig (5), Emacs Lisp (4), Factor (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Elixir (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2404), Jaldhar H. Vyas (2290), Roger Bell_West (2192), Luca Ferrari (2028), Arne Sommer (1766), Flavio Poletti (1716), Athanasius (1526), Ulrich Rieke (1378), Colin Crain (1336), Adam Russell (1170), Dave Jacoby (1108), Lubos Kolouch (1084), E. Choroba (1068), Paulo Custodio (976), Jorg Sommrey (932), W. Luis Mochan (928), James Smith (860), Simon Green (838), Duncan C. White (794), Cheok-Yin Fung (776), Mark Anderson (776), Mohammad Sajid Anwar (718), Stuart Little (644), Peter Campbell Smith (640), Feng Chang (606), Jan Krnavek (596), Abigail (574), Robert DiCicco (566), Niels van Dijke (550), Simon Proctor (542), Bruce Gray (516), Javier Luque (460), Bob Lied (454), Ruben Westerberg (452), Ali Moradi (402), Thomas Kohler (402), Stephen G. Lynn (400), Ryan Thompson (390), Wanderdoc (386), Pete Houston (360), Matthew Neleigh (352), Robert Ransbottom (348), Robbie Hatley (324), David Ferrone (298), Joelle Maslak (278), Andrezgz (252), Peter Meszaros (252), Steven Wilson (242), Matthias Muth (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), BarrOff (198), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Packy Anderson (190), Noud Aldenhoven (188), Solathian (188), Marton Polgar (178), Avery Adams (176), Kevin Colyer (176), Reinier Maliepaard (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Humberto Massa (112), Kjetil Skotheim (108), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/cheok-yin-fung/perl/ch-1.pl)]
...
[[**BLOG #1**](https://github.sommrey.de/blog/pwc/challenge-245/)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/reinier-maliepaard/perl/ch-1.pl)]
[[**BLOG #1**](https://reiniermaliepaard.nl/pwc/index.php?id=pwc245-1)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/mark-anderson/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-245/roger-bell-west/perl/ch-1.pl)]
