...
#### 2. Paulo Custodio (694)
    Ada (21), Awk (28), BASIC (44), Bc (17), Brainfuck (5), C (92), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (322).
#### 3. Roger Bell_West (646)
    Bash (1), JavaScript (32), Kotlin (37), Lua (36), Postscript (69), Python (169), Ruby (157), Rust (145).
#### 4. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 5. Lubos Kolouch (367)
    Bash (1), C++ (1), Go (5), Java (33), JavaScript (1), Kotlin (2), PHP (7), Python (315), Ruby (1), VBA (1).
#### 6. Ulrich Rieke (261)
    Awk (1), C (2), C++ (114), Haskell (134), Java (3), Lisp (7).
#### 7. AhmetEmre (234)
    BQN (234).
...
#### 11. Archar Gelod (104)
    Nim (104).
#### 12. Adam Russell (103)
    C++ (24), Java (1), Nuweb (3), Prolog (75).
#### 13. Myoungjin Jeon (85)
    Elm (10), Fish (1), Go (18), Haskell (34), Lisp (22).
#### 14. Eric Cheung (84)
    Excel VBA (63), Python (21).
#### 15. PokGoPun (80)
    Dart (12), Go (68).
#### 16. Richard Park (73)
    APL (68), BQN (1), JavaScript (2), Python (2).
#### 17. Conor Hoekstra (68)
    APL (38), BQN (19), C++ (1), Haskell (4), J (6).
...
***
    ...
    Python (1264), Haskell (450), Lua (330), Ruby (320), C (288), BQN (254), C++ (228), Rust (204), Node.js (191), Go (185), Awk (178), Java (171), Clojure (136), JavaScript (127), Bash (126), Nim (112), APL (106), Pascal (89), Postscript (88), Bc (79), Tcl (79), Prolog (78), R (74), BASIC (66), Excel VBA (63), Forth (60), Scheme (58), Kotlin (57), Scala (56), Lisp (41), PostgreSQL (41), PHP (39), Julia (38), Befunge-93 (35), Fortran (30), D (27), OCaml (25), Swift (25), Ada (23), SQL (23), Dart (22), Erlang (21), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Smalltalk (9), Ring (8), Brainfuck (6), J (6), Oberon (4), CESIL (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Zig (3), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), Miranda (2), Modula 3 (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1634), Jaldhar H. Vyas (1480), Roger Bell_West (1364), Arne Sommer (1224), Colin Crain (1094), Athanasius (952), Flavio Poletti (874), Luca Ferrari (868), Adam Russell (816), Ulrich Rieke (808), Dave Jacoby (782), E. Choroba (732), Lubos Kolouch (662), Paulo Custodio (644), Stuart Little (644), Jorg Sommrey (594), Mohammad Sajid Anwar (582), Duncan C. White (580), Abigail (574), James Smith (526), Cheok-Yin Fung (488), Simon Proctor (488), Simon Green (464), Javier Luque (460), Ruben Westerberg (452), Mark Anderson (450), W. Luis Mochan (426), Feng Chang (368), Wanderdoc (354), Pete Houston (348), Niels van Dijke (332), Jan Krnavek (308), Ryan Thompson (306), Joelle Maslak (274), Andrezgz (252), Yet Ebreo (222), Markus Holzer (198), Steven Wilson (198), Bruce Gray (192), Myoungjin Jeon (192), Noud Aldenhoven (188), Andrew Shitov (182), Kevin Colyer (176), Aaron Smith (174), Alexander Pankoff (172), Walt Mankowski (168), Duane Powell (164), Kian-Meng Ang (162), Peter Campbell Smith (162), Matthew Neleigh (144), Shahed Nooshmand (140), Mark Senn (136), Cristina Heredia (124), Dave Cross (120), Joan Mimosinnet (120), Robert DiCicco (120), Kang-min Liu (118), Bob Lied (116), Julio de Castro (116), Andinus (112), Gustavo Chaves (112), Saif Ahmed (110), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
### Ildar Shaimordanov
![Ildar Shaimordanov](/images/team/user.jpg)
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-161/arne-sommer/raku/ch-1.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-161/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-161/feng-chang/raku/ch-2.raku)]
...
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-161/jaldhar-h-vyas/perl/ch-2.pl)]
...
[[**BLOG #1**](https://www.braincells.com/perl/2022/04/perl_weekly_challenge_week_161.html)]
