...
#### 1. Abigail (992)
    Awk (97), Bash (82), Basic (10), Bc (34), Befunge (23), Brainfuck (1), C (99), C Shell (8), COBOL (7), Chef (1), Erlang (8), Forth (7), Fortran (9), Go (36), Java (33), Lua (84), M4 (3), MMIX (3), Macro Processor (4), Mumps (1), Node.js (103), OCaml (6), Ook (1), PHP (7), Pascal (36), Postscript (5), Python (88), R (31), Rexx (6), Ruby (82), SQL (11), Scheme (30), Sed (5), Tcl (31).
#### 2. Paulo Custodio (488)
    Ada (19), Adb (1), Awk (27), Basic (43), Bc (16), Brainfuck (4), C (57), C++ (56), D (13), Forth (41), Fortran (7), Lua (37), Pascal (5), Python (162).
#### 3. Stuart Little (436)
