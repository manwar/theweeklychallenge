...
#### 2) Richard Park: APL (29).
#### 3) Lubos Kolouch: Python (25).
#### 4) User Person: Python (21).
#### 5) Orestis Zekai: Python (16).
#### 6) Walt Mankowski: C (4), Python (10).
#### 7) Adam Russell: C++ (8), Prolog (2).
#### 8) Burkhard Nickels: Python (8).
#### 9) Leo Manfredi: Bash (2), Python (6).
#### 10) Sangeet Kar: Python (8).
#### 11) Wanderdoc: R (8).
#### 12) Arne Sommer: Bash (1), Node (1), PHP (1), Python (1), Ruby (1).
#### 13) Dave Jacoby: HTML (1), Node (2), Rust (2).
#### 14) Mohammad S Anwar: Swift (5).
...
#### **Colin Crain** moved up to the rank **#009**.
#### **Simon Proctor** moved up to the rank **#013**.
#### **Mark Anderson** moved up to the rank **#026**.
#### **Wanderdoc** moved up to the rank **#029**.
#### **Shahed Nooshmand** moved up to the rank **#032**.

<br>

#### 1) Laurent Rosenfeld (**796**)
#### 2) Jaldhar H. Vyas (**572**)
#### 3) Roger Bell_West (**474**)
#### 4) Arne Sommer (**462**)
...
#### 13) Simon Proctor (**268**)
#### 14) Dave Jacoby (**264**)
#### 15) Mohammad S Anwar (**260**)
...
#### 20) Ulrich Rieke (**198**)
#### 21) Kevin Colyer (**176**)
#### 22) Noud Aldenhoven (**172**)
#### 23) Kian-Meng Ang (**162**)
#### 24) Steven Wilson (**138**)
#### 25) Duane Powell (**136**)
#### 26) Mark Anderson (**132**)
#### 27) Markus Holzer (**130**)
#### 28) Cheok-Yin Fung (**124**)
#### 29) Wanderdoc (**122**)
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-070/ash/raku/ch-1.raku)]
