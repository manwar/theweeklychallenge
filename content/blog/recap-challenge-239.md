...
The total contributions in the week is `134`. Well done **Team PWC**. I would also like to thank `Raku` contributors for catching up.
...
#### 1. Roger Bell_West (1672)
    Bash (1), JavaScript (176), Kotlin (181), Lua (172), Postscript (217), Python (316), Ruby (304), Rust (295), Scala (10).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (982)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (244), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (606)
    Awk (3), C (2), C++ (225), Haskell (261), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (96).
#### 5. Lubos Kolouch (534)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (468), Ruby (1), VBA (1).
#### 6. Ali Moradi (501)
    APL (1), Ada (14), C (43), C++ (51), D (48), Go (7), Haskell (8), Java (8), Lisp (18), Lua (68), Modula 3 (46), Nelua (12), Nim (24), OCaml (6), Oberon (39), Pascal (60), Python (32), Ruby (16).
#### 7. Stuart Little (436)
...
#### 9. Robert DiCicco (341)
    BASIC (2), Bash (1), Go (2), Julia (109), Lua (2), PowerShell (9), Python (69), Ruby (122), Rust (1), Tcl (24).
#### 10. AhmetEmre (282)
    BQN (281), Javascript (1).
#### 11. Tyler Wardhaugh (260)
    Clojure (200), Fennel (8), Lua (36), Python (16).
#### 12. Eric Cheung (238)
    Excel VBA (63), Python (175).
#### 13. Adam Russell (178)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (130).
#### 14. PokGoPun (174)
    Dart (24), Go (128), Python (22).
#### 15. Luca Ferrari (167)
    PostgreSQL (163), Python (4).
#### 16. Simon Green (149)
    Python (149).
...
#### 28. Stephen G Lynn (46)
    Julia (46).
#### 29. Steven Wilson (45)
    Haskell (1), JavaScript (13), Python (30), Rust (1).
#### 30. Nuno Vieira (44)
    JavaScript (44).
...
#### 34. BarrOff (26)
    Awk (1), GP (2), Julia (14), Nim (8), V (1).
#### 35. Andreas Voegele (22)
    Kotlin (22).
#### 36. Packy Anderson (22)
    Java (8), Python (14).
...
#### 71. Augie De Blieck Jr. (4)
    Elixir (2), JavaScript (1), Python (1).
#### 72. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 73. Ben Davies (4)
    Idris (2), Scala (2).
#### 74. E. Choroba (4)
    C (1), Erlang (3).
#### 75. Julien Fiegehenn (4)
    TypeScript (4).
#### 76. Karishma Rajput (4)
    C (1), C++ (1), JavaScript (1), Node.js (1).
#### 77. Kivanc Yazan (4)
    Python (4).
#### 78. Kjetil Skotheim (4)
    Scala (4).
#### 79. Kueppo Wesley (4)
    Node.js (4).
#### 80. Macy TY (4)
...
#### 85. Andinus (3)
    C (3).
#### 86. Andrii Mishchenko (3)
    Ruby (3).
#### 87. Gabor Szabo (3)
    Crystal (3).
#### 88. Guillermo Ramos (3)
    Go (3).
#### 89. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 90. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 91. Rage311 (3)
    Rust (3).
#### 92. Carlos Oliveira (2)
    C (2).
#### 93. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 94. Humberto Massa (2)
...
***
    ...
    Python (2181), Ruby (614), Haskell (600), C (591), Lua (534), Rust (478), C++ (419), BQN (317), JavaScript (306), Go (290), Java (277), Postscript (236), Julia (234), Kotlin (234), Clojure (200), Node.js (196), Awk (190), PostgreSQL (163), Nim (150), Pascal (149), Prolog (139), APL (138), Bash (132), Tcl (101), BASIC (100), Forth (92), Bc (84), D (82), Scala (82), R (75), Lisp (64), Excel VBA (63), Scheme (58), Modula 3 (46), PHP (41), Swift (41), Dart (40), Oberon (39), Ada (35), Befunge-93 (35), Fortran (33), OCaml (31), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), F# (12), Nelua (12), J (11), PowerShell (11), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), Uiua (4), CESIL (3), Coconut (3), Crystal (3), Elixir (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2358), Jaldhar H. Vyas (2230), Roger Bell_West (2132), Luca Ferrari (1906), Arne Sommer (1726), Flavio Poletti (1716), Athanasius (1478), Colin Crain (1336), Ulrich Rieke (1330), Adam Russell (1122), Dave Jacoby (1076), E. Choroba (1044), Lubos Kolouch (1026), Paulo Custodio (952), Jorg Sommrey (900), W. Luis Mochan (892), James Smith (860), Simon Green (808), Duncan C. White (794), Cheok-Yin Fung (752), Mark Anderson (752), Mohammad Sajid Anwar (718), Stuart Little (644), Peter Campbell Smith (604), Feng Chang (582), Abigail (574), Jan Krnavek (574), Robert DiCicco (558), Simon Proctor (540), Niels van Dijke (526), Bruce Gray (492), Javier Luque (460), Ruben Westerberg (452), Bob Lied (428), Stephen G. Lynn (400), Ryan Thompson (390), Wanderdoc (378), Pete Houston (360), Thomas Kohler (354), Ali Moradi (346), Robert Ransbottom (334), Matthew Neleigh (328), Robbie Hatley (288), Joelle Maslak (278), David Ferrone (274), Andrezgz (252), Steven Wilson (242), Peter Meszaros (228), Yet Ebreo (222), Alexander Pankoff (220), Andrew Shitov (216), Markus Holzer (198), Matthias Muth (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Reinier Maliepaard (188), Marton Polgar (178), Avery Adams (176), Kevin Colyer (176), Solathian (176), Aaron Smith (174), BarrOff (172), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Packy Anderson (130), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/cheok-yin-fung/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/kjetillll/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/peter-campbell-smith/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/reinier-maliepaard/perl/ch-1.pl)]
[[**BLOG #1**](https://reiniermaliepaard.nl/pwc/index.php?id=pwc239-1)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/wambash/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-239/robert-dicicco/perl/ch-1.pl)]
