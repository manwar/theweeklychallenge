...
#### 1. Abigail (877)
    Awk (85), BASIC (10), Bash (72), Bc (27), Befunge-93 (23), Brainfuck (1), C (87), C Shell (8), COBOL (7), Chef (1), Erlang (7), Forth (7), Fortran (9), Go (32), Java (29), Lua (72), M4 (7), MMIX (3), Mumps (1), Node.js (91), OCaml (6), Ook (1), PHP (7), Pascal (32), Postscript (5), Python (76), R (28), Rexx (6), Ruby (70), SQL (11), Scheme (26), Sed (5), Tcl (25).
#### 2. Paulo Custodio (638)
    Ada (21), Awk (28), BASIC (44), Bc (17), Brainfuck (5), C (90), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (268).
#### 3. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 4. Roger Bell_West (327)
    Bash (1), Postscript (17), Python (115), Ruby (103), Rust (91).
#### 5. Lubos Kolouch (301)
    Bash (1), C++ (1), Go (5), Java (27), JavaScript (1), Kotlin (2), PHP (1), Python (261), Ruby (1), VBA (1).
#### 6. AhmetEmre (234)
    BQN (234).
#### 7. Ulrich Rieke (174)
    Awk (1), C (2), C++ (73), Haskell (90), Java (1), Lisp (7).
#### 8. Tyler Wardhaugh (156)
    Clojure (106), Lua (36), Python (14).
...
#### 16. Nuno Vieira (44)
    JavaScript (44).
#### 17. Cheok-Yin Fung (43)
    Awk (2), Bash (5), Java (10), Julia (3), Lisp (11), Node.js (1), Python (3), Smalltalk (8).
#### 18. Conor Hoekstra (43)
    APL (20), BQN (13), C++ (1), Haskell (4), J (5).
...
***
    ...
    Python (980), Haskell (400), BQN (248), Lua (242), C (237), Ruby (201), C++ (174), Node.js (151), Rust (146), Awk (132), Java (110), Nim (109), Clojure (106), Go (93), JavaScript (89), APL (88), Bash (85), Prolog (57), BASIC (54), Scala (52), Forth (49), Bc (45), Pascal (45), Lisp (41), R (40), Tcl (37), Excel VBA (29), Scheme (26), Postscript (25), D (24), Befunge-93 (23), PHP (22), Ada (21), Fortran (19), Swift (18), Kotlin (16), Elm (15), OCaml (14), Julia (13), SQL (11), Dart (9), Erlang (9), C Shell (8), Smalltalk (8), COBOL (7), M4 (7), Brainfuck (6), Rexx (6), Sed (6), J (5), CESIL (3), Crystal (3), Gembase (3), Janet (3), MMIX (3), Nuweb (3), Zig (3), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), Miranda (2), Modula 3 (2), Myrddin (2), Nix (2), Oberon (2), Odin (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1360), Jaldhar H. Vyas (1210), Roger Bell_West (1094), Arne Sommer (1006), Colin Crain (858), Athanasius (740), Adam Russell (680), Stuart Little (644), E. Choroba (622), Dave Jacoby (616), Ulrich Rieke (604), Luca Ferrari (556), Lubos Kolouch (554), Flavio Poletti (550), Paulo Custodio (536), Jorg Sommrey (496), Mohammad Sajid Anwar (490), Duncan C. White (474), Simon Proctor (464), Javier Luque (460), Ruben Westerberg (452), Abigail (434), Cheok-Yin Fung (416), James Smith (364), Mark Anderson (364), Simon Green (346), Wanderdoc (336), Ryan Thompson (294), Feng Chang (284), Joelle Maslak (274), Pete Houston (264), W. Luis Mochan (264), Niels van Dijke (256), Andrezgz (234), Jan Krnavek (224), Yet Ebreo (222), Markus Holzer (198), Myoungjin Jeon (192), Noud Aldenhoven (188), Kevin Colyer (176), Aaron Smith (174), Steven Wilson (172), Andrew Shitov (164), Duane Powell (164), Kian-Meng Ang (162), Walt Mankowski (162), Shahed Nooshmand (140), Dave Cross (120), Joan Mimosinnet (120), Kang-min Liu (118), Cristina Heredia (116), Julio de Castro (116), Gustavo Chaves (112), Saif Ahmed (110), Bob Lied (108), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104), Andinus (102).
...
[[**BLOG #1**](https://github.com/drbaggy/perlweeklychallenge-club/tree/master/challenge-134/james-smith)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-134/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-134/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-134/roger-bell-west/perl/ch-1.pl)]
