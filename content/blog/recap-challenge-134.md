...
#### 1. Abigail (793)
    Awk (83), Bash (68), Basic (10), Bc (20), Befunge (23), Brainfuck (1), C (86), C Shell (8), COBOL (7), Chef (1), Erlang (7), Forth (7), Fortran (9), Go (20), Java (19), Lua (70), M4 (3), MMIX (3), Macro Processor (4), Mumps (1), Node.js (89), OCaml (6), Ook (1), PHP (7), Pascal (22), Postscript (5), Python (74), R (19), Rexx (6), Ruby (68), SQL (11), Scheme (15), Sed (5), Tcl (15).
#### 2. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 3. Paulo Custodio (353)
    Ada (19), Awk (25), Basic (41), Bc (14), Brainfuck (1), C (55), C++ (55), D (12), Forth (39), Fortran (6), Lua (35), Pascal (4), Python (47).
#### 4. Roger Bell_West (327)
    Bash (1), Postscript (17), Python (115), Ruby (103), Rust (91).
#### 5. Ulrich Rieke (174)
    Awk (1), C (2), C++ (73), Haskell (90), Java (1), Lisp (7).
#### 6. Tyler Wardhaugh (156)
    Clojure (106), Lua (36), Python (14).
#### 7. Laurent Rosenfeld (141)
...
#### 12. Mohammad Meraj Zia (45)
    Java (37), Kotlin (8).
#### 13. Nuno Vieira (44)
    JavaScript (44).
#### 14. Cheok-Yin Fung (43)
...
#### 17. Conor Hoekstra (33)
    APL (16), BQN (7), C++ (1), Haskell (4), J (5).
#### 18. Eric Cheung (32)
...
#### 57. Tejas (2)
    C++ (2).
#### 58. Alexander Pankoff (1)
    Haskell (1).
#### 59. Bob Lied (1)
    C (1).
#### 60. Bruce Gray (1)
    SVG (1).
#### 61. Christian Jaeger (1)
    Haskell (1).
#### 62. Darren Bottin (1)
    Prolog (1).
#### 63. David Schwartz (1)
