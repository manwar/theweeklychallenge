...
#### 7. AhmetEmre (250)
    BQN (250).
#### 8. Tyler Wardhaugh (218)
    Clojure (158), Fennel (8), Lua (36), Python (16).
#### 9. Adam Russell (148)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (100).
#### 10. Ali Moradi (139)
    Ada (8), C (10), C++ (21), D (17), Haskell (2), Lua (26), Modula 3 (10), Nelua (2), Nim (8), Oberon (5), Pascal (24), Python (6).
#### 11. Eric Cheung (138)
...
#### 21. Mohammad Meraj Zia (65)
    Java (57), Kotlin (8).
#### 22. Simon Green (58)
    Python (58).
#### 23. Duncan C. White (47)
    C (42), Pascal (2), Postscript (3).
#### 24. Nuno Vieira (44)
    JavaScript (44).
#### 25. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 26. Stephen G Lynn (37)
    Julia (37).
#### 27. Andrew Shitov (34)
