...
#### 1. Abigail (1482)
    Awk (120), BASIC (20), Bash (108), Bc (56), Befunge (32), Brainfuck (1), C (122), C Shell (17), COBOL (16), Chef (1), Erlang (17), Forth (16), Fortran (18), Go (64), Java (61), Lua (108), M4 (12), MMIX (12), Macro Processor (4), Mumps (1), Node.js (127), OCaml (15), Ook (1), PHP (15), Pascal (64), Postscript (14), Python (112), R (59), Rexx (15), Ruby (106), SQL (21), Scheme (56), Sed (13), Tcl (58).
...
#### 7. Tyler Wardhaugh (180)
    Clojure (130), Lua (36), Python (14).
#### 8. Lubos Kolouch (98)
    Java (2), PHP (6), Python (90).
#### 9. Adam Russell (97)
...
#### 13. Cheok-Yin Fung (59)
    Awk (3), Bash (6), Befunge (1), C++ (1), Dart (2), Java (13), JavaScript (1), Julia (7), Lisp (11), Node.js (2), Python (3), Smalltalk (9).
...
#### 59. Guillermo Ramos (3)
    Go (3).
#### 60. Karishma Rajput (3)
    C (1), C++ (1), JavaScript (1).
#### 61. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 62. Rage311 (3)
    Rust (3).
