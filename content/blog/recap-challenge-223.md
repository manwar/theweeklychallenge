...
#### 2. Roger Bell_West (1452)
    Bash (1), JavaScript (146), Kotlin (151), Lua (142), Postscript (187), Python (286), Ruby (274), Rust (265).
...
#### 4. Ulrich Rieke (524)
    Awk (3), C (2), C++ (200), Haskell (233), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (67).
#### 5. Lubos Kolouch (503)
    Bash (6), C++ (1), Go (5), Java (39), JavaScript (1), Kotlin (2), PHP (9), Python (438), Ruby (1), VBA (1).
#### 6. Stuart Little (436)
...
#### 10. Tyler Wardhaugh (248)
    Clojure (188), Fennel (8), Lua (36), Python (16).
#### 11. Robert DiCicco (239)
    BASIC (2), Bash (1), Go (2), Julia (84), Lua (1), Python (41), Ruby (95), Rust (1), Tcl (12).
#### 12. Eric Cheung (208)
    Excel VBA (63), Python (145).
#### 13. Adam Russell (166)
...
***
    ...
    Python (1951), Haskell (561), C (545), Ruby (540), Lua (483), Rust (416), C++ (386), BQN (305), Go (263), Java (259), JavaScript (255), Postscript (206), Node.js (196), Julia (194), Awk (189), Clojure (188), Kotlin (188), Nim (142), Pascal (137), PostgreSQL (135), Bash (132), APL (128), Prolog (125), BASIC (100), Forth (92), Tcl (89), Bc (84), R (75), D (74), Scala (70), Excel VBA (63), Scheme (58), Lisp (43), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Modula 3 (34), Fortran (33), Oberon (29), OCaml (27), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Nelua (12), F# (10), J (9), Smalltalk (9), Fennel (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2216), Jaldhar H. Vyas (2080), Roger Bell_West (1982), Luca Ferrari (1676), Arne Sommer (1636), Flavio Poletti (1608), Athanasius (1366), Colin Crain (1336), Lubos Kolouch (1336), Ulrich Rieke (1220), Adam Russell (1062), Dave Jacoby (1000), E. Choroba (984), Paulo Custodio (892), James Smith (860), Jorg Sommrey (840), W. Luis Mochan (802), Duncan C. White (794), Simon Green (732), Mohammad Sajid Anwar (718), Cheok-Yin Fung (706), Mark Anderson (688), Stuart Little (644), Abigail (574), Simon Proctor (536), Feng Chang (522), Peter Campbell Smith (516), Jan Krnavek (516), Niels van Dijke (484), Javier Luque (460), Ruben Westerberg (452), Robert DiCicco (448), Bruce Gray (436), Ryan Thompson (390), Pete Houston (360), Wanderdoc (358), Stephen G. Lynn (352), Bob Lied (348), Robert Ransbottom (282), Matthew Neleigh (278), Joelle Maslak (274), Andrezgz (252), Thomas Kohler (234), Yet Ebreo (222), Alexander Pankoff (220), Ali Moradi (214), Steven Wilson (214), David Ferrone (214), Robbie Hatley (204), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Andrew Shitov (190), Noud Aldenhoven (188), Kevin Colyer (176), Marton Polgar (174), Aaron Smith (174), Peter Meszaros (168), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Solathian (142), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Reinier Maliepaard (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Avery Adams (108), Matthias Muth (108), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-223.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-223/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-223/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-223/sgreen/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-223/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-223/feng-chang/raku/ch-2.raku)]
...
[[**BLOG #1**](https://www.braincells.com/perl/2023/07/perl_weekly_challenge_week_223.html)]
