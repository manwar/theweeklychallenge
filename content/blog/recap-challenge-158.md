...
#### 2. Paulo Custodio (688)
    Ada (21), Awk (28), BASIC (44), Bc (17), Brainfuck (5), C (92), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (316).
#### 3. Roger Bell_West (604)
    Bash (1), JavaScript (26), Kotlin (31), Lua (30), Postscript (63), Python (163), Ruby (151), Rust (139).
#### 4. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 5. Lubos Kolouch (361)
    Bash (1), C++ (1), Go (5), Java (33), JavaScript (1), Kotlin (2), PHP (7), Python (309), Ruby (1), VBA (1).
#### 6. Ulrich Rieke (249)
    Awk (1), C (2), C++ (108), Haskell (128), Java (3), Lisp (7).
#### 7. AhmetEmre (234)
    BQN (234).
...
#### 18. Cheok-Yin Fung (61)
    Awk (3), Bash (6), Befunge-93 (1), C++ (1), Dart (4), Java (13), JavaScript (1), Julia (7), Lisp (11), Node.js (2), Python (3), Smalltalk (9).
#### 19. Mohammad Meraj Zia (50)
    Java (42), Kotlin (8).
#### 20. Ali Moradi (48)
    Ada (2), C (6), C++ (6), D (4), Go (2), Lua (8), Modula 3 (2), Nim (2), Oberon (4), Pascal (8), Python (2), Ruby (2).
...
#### 26. Simon Green (29)
    Python (29).
#### 27. Robert DiCicco (28)
    Bash (1), Julia (4), Python (4), Ruby (13), Tcl (6).
#### 28. Ian Goodnight (21)
...
#### 34. Orestis Zekai (16)
    Python (16).
#### 35. Bruce Gray (14)
    C (3), Dart (2), Go (2), Julia (2), Python (2), SVG (1), WebAssembly (2).
#### 36. Lucas Ransan (14)
...
***
    ...
    Python (1238), Haskell (441), Lua (322), Ruby (310), C (286), BQN (253), C++ (220), Rust (198), Node.js (191), Go (179), Awk (178), Java (168), Clojure (134), Bash (126), JavaScript (121), Nim (112), APL (104), Pascal (87), Postscript (82), Bc (79), Tcl (79), Prolog (75), R (74), BASIC (66), Excel VBA (63), Forth (60), Scheme (58), Scala (56), Kotlin (51), Lisp (41), PHP (39), Befunge-93 (35), PostgreSQL (35), Julia (34), Fortran (30), D (27), OCaml (25), Swift (25), Ada (23), SQL (23), Dart (22), Erlang (21), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Smalltalk (9), Ring (8), Brainfuck (6), J (6), Oberon (4), CESIL (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Zig (3), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), Miranda (2), Modula 3 (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1604), Jaldhar H. Vyas (1450), Roger Bell_West (1334), Arne Sommer (1202), Colin Crain (1068), Lubos Kolouch (946), Athanasius (926), Flavio Poletti (838), Luca Ferrari (820), Adam Russell (794), Ulrich Rieke (784), Dave Jacoby (764), E. Choroba (720), Stuart Little (644), Paulo Custodio (632), Jorg Sommrey (582), Mohammad Sajid Anwar (576), Abigail (574), Duncan C. White (568), James Smith (508), Simon Proctor (480), Cheok-Yin Fung (472), Javier Luque (460), Simon Green (458), Ruben Westerberg (452), Mark Anderson (442), W. Luis Mochan (408), Feng Chang (360), Wanderdoc (354), Pete Houston (338), Niels van Dijke (330), Jan Krnavek (300), Ryan Thompson (298), Joelle Maslak (274), Andrezgz (250), Yet Ebreo (222), Markus Holzer (198), Steven Wilson (198), Myoungjin Jeon (192), Noud Aldenhoven (188), Andrew Shitov (182), Bruce Gray (178), Kevin Colyer (176), Aaron Smith (174), Walt Mankowski (168), Duane Powell (164), Kian-Meng Ang (162), Alexander Pankoff (160), Peter Campbell Smith (150), Shahed Nooshmand (140), Mark Senn (136), Matthew Neleigh (134), Cristina Heredia (124), Dave Cross (120), Joan Mimosinnet (120), Kang-min Liu (118), Bob Lied (116), Julio de Castro (116), Gustavo Chaves (112), Saif Ahmed (110), Alicia Bielsa (106), Burkhard Nickels (106), Andinus (104), Nuno Vieira (104).
...
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-158.html)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-158/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-158/feng-chang/raku/ch-2.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-158/wambash/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-158/colin-crain/perl/ch-1.pl)]
