...
#### 1. Roger Bell_West (2502)
    Bash (1), Crystal (43), JavaScript (274), Kotlin (279), Lua (269), Postscript (316), Python (414), Ruby (402), Rust (396), Scala (108).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1126)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (346), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (386).
#### 4. Ulrich Rieke (884)
    Awk (3), C (2), C++ (316), Haskell (354), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (190).
#### 5. Ali Moradi (691)
...
#### 6. Lubos Kolouch (636)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (570), Ruby (1), VBA (1).
#### 7. David Ferrone (474)
...
#### 18. Packy Anderson (170)
    Elixir (47), Java (8), Python (115).
#### 19. Conor Hoekstra (154)
    APL (63), BQN (69), C++ (2), Haskell (6), J (8), Python (3), Rust (1), Uiua (2).
#### 20. Archar Gelod (124)
    Nim (124).
#### 21. BarrOff (114)
...
***
    ...
    Python (3133), C (794), Rust (772), Ruby (737), Haskell (713), Lua (649), C++ (553), JavaScript (499), Go (425), BQN (380), Java (376), Postscript (335), Kotlin (332), Julia (308), PostgreSQL (247), Clojure (202), Bash (200), Node.js (196), Awk (190), Nim (187), Scala (182), Prolog (172), Pascal (159), APL (154), Tcl (122), BASIC (100), R (100), Forth (98), D (93), Modula 3 (88), Bc (84), Lisp (75), Elixir (68), Excel VBA (63), Scheme (60), PHP (51), Oberon (47), Crystal (46), Swift (41), Dart (40), Ada (37), Befunge-93 (35), Fortran (33), OCaml (33), Uiua (30), Erlang (24), J (24), SQL (24), COBOL (20), Ring (20), C Shell (19), F# (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), Hy (10), Racket (10), C# (9), Smalltalk (9), Fennel (8), Zig (7), Brainfuck (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), Nu (4), Standard ML (4), CESIL (3), Gembase (3), Janet (3), K (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), Chef (1), Fish (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (2890), Laurent Rosenfeld (2882), Jaldhar H. Vyas (2740), Roger Bell_West (2634), Arne Sommer (2038), Athanasius (1868), Flavio Poletti (1716), Ulrich Rieke (1702), Colin Crain (1336), Dave Jacoby (1336), Lubos Kolouch (1334), Adam Russell (1256), E. Choroba (1252), Jorg Sommrey (1204), W. Luis Mochan (1198), Paulo Custodio (1156), Simon Green (1054), Mark Anderson (954), Peter Campbell Smith (910), Cheok-Yin Fung (884), James Smith (882), Duncan C. White (794), Feng Chang (786), Jan Krnavek (764), Thomas Kohler (746), Mohammad Sajid Anwar (718), Niels van Dijke (694), Bruce Gray (674), Bob Lied (670), Ali Moradi (666), Stuart Little (644), Packy Anderson (640), Abigail (574), Robert DiCicco (574), Robbie Hatley (568), Simon Proctor (560), Matthew Neleigh (520), Robert Ransbottom (512), Wanderdoc (512), David Ferrone (480), Stephen G. Lynn (478), Javier Luque (460), Ruben Westerberg (452), Ryan Thompson (430), Peter Meszaros (428), Matthias Muth (410), Reinier Maliepaard (382), BarrOff (366), Pete Houston (360), Joelle Maslak (314), Andrezgz (264), Andrew Shitov (254), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Kjetil Skotheim (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Nelo Tovar (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Mariano Spadaccini (134), Andinus (132), Pip Stuart (132), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-290/adam-russell/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-290/adam-russell/perl/ch-2.pl)]
[[**BLOG #1**](http://www.rabbitfarm.com/cgi-bin/blosxom/perl/2024/10/14)]
[[**BLOG #2**](http://www.rabbitfarm.com/cgi-bin/blosxom/prolog/2024/10/14)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-290/deadmarshal/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-290/mark-anderson/raku/ch-1.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-290/laurent-rosenfeld/perl/ch-1.pl)]
