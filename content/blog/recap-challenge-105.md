---
title: "RECAP - The Weekly Challenge - 105"
date: 2026-05-15T00:00:00+00:00
description: "Quick recap of The Weekly Challenge - 105."
type: post
...
#### 1. Paulo Custodio (489)
    Ada (16), Awk (22), BASIC (38), Bc (10), Brainfuck (3), C (75), C++ (44), D (1), Forth (36), Fortran (1), Lua (32), Pascal (1), Python (210).
#### 2. Abigail (342)
    Awk (36), BASIC (4), Bash (29), Bc (10), Befunge-93 (11), Brainfuck (1), C (40), C Shell (2), COBOL (2), Chef (1), Erlang (1), Forth (2), Fortran (3), Go (8), Java (8), Lua (28), M4 (1), Mumps (1), Node.js (47), OCaml (1), Ook (1), PHP (1), Pascal (11), Python (31), R (9), Rexx (1), Ruby (29), SQL (6), Scheme (10), Sed (1), Tcl (6).
#### 3. Stuart Little (254)
    Haskell (210), Lua (42), Python (2).
#### 4. Lubos Kolouch (245)
    Bash (1), C++ (1), Go (5), Java (23), JavaScript (1), Kotlin (2), PHP (1), Python (209), Ruby (1), VBA (1).
#### 5. AhmetEmre (199)
    BQN (199).
#### 6. Roger Bell_West (155)
    Postscript (2), Python (63), Ruby (51), Rust (39).
#### 7. David Ferrone (116)
    C (29), JavaScript (29), Python (29), Rust (29).
#### 8. Tyler Wardhaugh (114)
    Clojure (66), Lua (36), Python (12).
#### 9. Ulrich Rieke (109)
    C++ (47), Haskell (59), Java (1), Lisp (2).
#### 10. Archar Gelod (104)
    Nim (104).
...
#### 13. Laurent Rosenfeld (57)
    Awk (2), Bc (1), C (2), D (1), Dart (1), Gembase (3), Go (1), Java (1), Julia (1), Kotlin (1), Lua (1), Nim (1), Python (12), Ruby (2), Rust (1), Scala (25), Visual BASIC (1).
#### 14. Nuno Vieira (44)
    JavaScript (44).
#### 15. Adam Russell (41)
    C++ (11), Prolog (30).
...
***
    ...
    Python (683), Haskell (319), BQN (210), C (158), Lua (140), C++ (123), Nim (107), Ruby (98), Rust (87), JavaScript (79), APL (66), Clojure (66), Awk (65), Java (59), Node.js (56), Go (50), BASIC (42), Forth (38), Lisp (36), Bash (34), Scala (34), Prolog (33), Bc (21), R (21), Swift (18), Tcl (17), Ada (16), Elm (13), Kotlin (13), Pascal (13), Befunge-93 (11), PHP (11), Scheme (10), OCaml (9), Dart (8), Smalltalk (8), SQL (6), Fortran (5), Postscript (5), Brainfuck (4), D (3), Erlang (3), Gembase (3), Janet (3), C Shell (2), COBOL (2), HTML (2), Haxe (2), Idris (2), Julia (2), C# (1), Chef (1), Fish (1), GNAT (1), J (1), M4 (1), Mumps (1), Ook (1), Rexx (1), Sed (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (1102), Jaldhar H. Vyas (960), Roger Bell_West (816), Arne Sommer (752), Colin Crain (638), Athanasius (580), Adam Russell (510), E. Choroba (506), Javier Luque (460), Stuart Little (460), Ruben Westerberg (452), Dave Jacoby (440), Lubos Kolouch (438), Ulrich Rieke (422), Paulo Custodio (420), Mohammad Sajid Anwar (398), Simon Proctor (392), Jorg Sommrey (384), Duncan C. White (368), Luca Ferrari (348), Cheok-Yin Fung (284), Ryan Thompson (282), Joelle Maslak (274), Mark Anderson (260), Wanderdoc (246), Flavio Poletti (230), Andrezgz (222), Yet Ebreo (222), Abigail (206), Feng Chang (202), Simon Green (200), James Smith (196), Myoungjin Jeon (192), Markus Holzer (190), Noud Aldenhoven (188), Kevin Colyer (176), Niels van Dijke (166), Pete Houston (166), Kian-Meng Ang (162), Walt Mankowski (162), Andrew Shitov (160), Steven Wilson (154), Duane Powell (148), Shahed Nooshmand (140), Jan Krnavek (126), Kang-min Liu (118), Julio de Castro (116), Gustavo Chaves (112), Saif Ahmed (110), Aaron Smith (106), Alicia Bielsa (106), Burkhard Nickels (106), Bob Lied (104), Dave Cross (104), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-105/adam-russell/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-105/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-105/lubos-kolouch/perl/ch-2.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-105/mimosinnet/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-105/mimosinnet/raku/ch-2.raku)]
...
[[**BLOG #1**](https://colincrain.com/2021/03/28/the-root-of-a-name/)]
...
[[**BLOG #1**](https://blog.firedrake.org/archive/2021/03/Perl_Weekly_Challenge_105__Name_Root.html)]
