...
#### 1. Roger Bell_West (2906)
    Bash (1), Crystal (88), JavaScript (319), Kotlin (324), Lua (314), Postscript (360), Python (459), Ruby (447), Rust (442), Scala (152).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (1176)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (392), C++ (101), D (14), Forth (80), Fortran (8), Lua (38), Pascal (6), Python (390).
#### 4. Ulrich Rieke (1016)
    Awk (3), C (2), C++ (360), Haskell (398), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (234).
#### 5. Ali Moradi (759)
    APL (1), Ada (14), C (55), C++ (67), D (58), Go (17), Haskell (10), Java (68), Lisp (20), Lua (90), Modula 3 (110), Nelua (12), Nim (24), OCaml (8), Oberon (47), Pascal (70), Python (38), Ruby (34), Scheme (4), Standard ML (6), Zig (6).
#### 6. Lubos Kolouch (682)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (616), Ruby (1), VBA (1).
#### 7. David Ferrone (474)
    C (115), JavaScript (109), Python (110), R (19), Rust (121).
#### 8. PokGoPun (469)
    Dart (24), Go (276), Python (169).
#### 9. Stuart Little (436)
...
#### 18. Conor Hoekstra (215)
    APL (66), BQN (111), C++ (2), CUDA (1), Haskell (6), J (8), Kap (4), Python (4), Rust (1), Uiua (12).
#### 19. Packy Anderson (185)
    Elixir (54), Java (8), Python (123).
#### 20. BarrOff (143)
    Ada (1), Awk (1), BQN (9), D (3), GP (2), Julia (83), Nim (36), Pascal (5), V (3).
#### 21. Steven Wilson (135)
    Haskell (1), JavaScript (13), Python (120), Rust (1).
#### 22. Archar Gelod (124)
    Nim (124).
...
#### 25. Mariano Spadaccini (100)
    Bash (1), Elixir (12), Go (32), Korn Shell (2), Octave (1), Python (36), R (1), Ruby (15).
...
***
    ...
    Python (3425), Rust (868), C (841), Ruby (784), Haskell (759), Lua (698), C++ (599), JavaScript (544), Go (472), BQN (424), Java (416), Postscript (379), Kotlin (377), Julia (324), PostgreSQL (259), Scala (234), Clojure (202), Bash (200), Nim (198), Node.js (196), Prolog (194), Awk (190), APL (167), Pascal (164), Tcl (160), Modula 3 (110), BASIC (100), R (100), Forth (98), D (95), Crystal (91), Bc (84), Elixir (75), Lisp (75), Excel VBA (63), Scheme (62), PHP (51), Oberon (47), Uiua (44), Dart (42), Swift (41), Ada (38), Befunge-93 (35), Fortran (33), OCaml (33), J (26), Erlang (24), SQL (24), COBOL (20), F# (20), Ring (20), C Shell (19), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), PowerShell (13), Nelua (12), Zig (11), C# (10), Hy (10), Racket (10), Smalltalk (9), Fennel (8), Brainfuck (6), Standard ML (6), TypeScript (6), Coconut (4), Emacs Lisp (4), Factor (4), Groovy (4), K (4), Kap (4), Nu (4), CESIL (3), Fish (3), Gembase (3), Janet (3), Logo (3), Nuweb (3), Octave (3), Roc (3), V (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), CUDA (1), Chef (1), GNAT (1), IO (1), Javascript (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), Typescript (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Luca Ferrari (3066), Jaldhar H. Vyas (2970), Laurent Rosenfeld (2906), Roger Bell_West (2860), Arne Sommer (2176), Athanasius (2034), Lubos Kolouch (1978), Ulrich Rieke (1872), Flavio Poletti (1716), Dave Jacoby (1428), E. Choroba (1344), Jorg Sommrey (1342), Colin Crain (1336), W. Luis Mochan (1336), Adam Russell (1320), Paulo Custodio (1248), Simon Green (1146), Peter Campbell Smith (1042), Mark Anderson (1034), Thomas Kohler (906), Cheok-Yin Fung (892), James Smith (882), Feng Chang (878), Jan Krnavek (840), Duncan C. White (794), Ali Moradi (776), Bob Lied (762), Niels van Dijke (736), Mohammad Sajid Anwar (718), Robbie Hatley (706), Packy Anderson (682), Bruce Gray (674), Stuart Little (644), Robert Ransbottom (596), Wanderdoc (588), Abigail (574), Robert DiCicco (574), David Ferrone (572), Matthew Neleigh (562), Simon Proctor (560), Matthias Muth (524), Peter Meszaros (512), Stephen G. Lynn (478), Javier Luque (460), Ruben Westerberg (452), Ryan Thompson (442), BarrOff (412), Reinier Maliepaard (390), Pete Houston (360), Joelle Maslak (314), Kjetil Skotheim (284), Steven Wilson (270), Andrezgz (264), Andrew Shitov (254), Yet Ebreo (222), Alexander Pankoff (220), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Solathian (192), Noud Aldenhoven (188), Marton Polgar (182), Avery Adams (176), Kevin Colyer (176), Nelo Tovar (176), Aaron Smith (174), Duane Powell (164), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Mariano Spadaccini (138), Andinus (132), Pip Stuart (132), Humberto Massa (128), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Santiago Leyva (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-313/lubos-kolouch/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-313/lubos-kolouch/perl/ch-2.pl)]
[[**BLOG #1**](https://kolouch.net/perlweeklychallenge/blog-313.html)]
