...
#### 2. Paulo Custodio (690)
    Ada (21), Awk (28), BASIC (44), Bc (17), Brainfuck (5), C (92), C++ (57), D (14), Forth (42), Fortran (8), Lua (38), Pascal (6), Python (318).
#### 3. Roger Bell_West (618)
    Bash (1), JavaScript (28), Kotlin (33), Lua (32), Postscript (65), Python (165), Ruby (153), Rust (141).
#### 4. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 5. Lubos Kolouch (363)
    Bash (1), C++ (1), Go (5), Java (33), JavaScript (1), Kotlin (2), PHP (7), Python (311), Ruby (1), VBA (1).
#### 6. Ulrich Rieke (253)
    Awk (1), C (2), C++ (110), Haskell (130), Java (3), Lisp (7).
#### 7. AhmetEmre (234)
    BQN (234).
...
#### 26. Robert DiCicco (31)
    Bash (1), Julia (5), Python (4), Ruby (15), Tcl (6).
#### 27. Simon Green (29)
    Python (29).
#### 28. Ian Goodnight (21)
...
***
    ...
    Python (1246), Haskell (443), Lua (324), Ruby (314), C (286), BQN (253), C++ (222), Rust (200), Node.js (191), Go (181), Awk (178), Java (169), Clojure (134), Bash (126), JavaScript (123), Nim (112), APL (104), Pascal (87), Postscript (84), Bc (79), Tcl (79), Prolog (75), R (74), BASIC (66), Excel VBA (63), Forth (60), Scheme (58), Scala (56), Kotlin (53), Lisp (41), PHP (39), PostgreSQL (37), Julia (36), Befunge-93 (35), Fortran (30), D (27), OCaml (25), Swift (25), Ada (23), SQL (23), Dart (22), Erlang (21), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), Smalltalk (9), Ring (8), Brainfuck (6), J (6), Oberon (4), CESIL (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Zig (3), C3 (2), Coconut (2), HTML (2), Haxe (2), Idris (2), Miranda (2), Modula 3 (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), Bourne Shell (1), C# (1), Chef (1), Fish (1), GNAT (1), IO (1), Logo (1), Mumps (1), Ook (1), SVG (1), VBA (1), Visual BASIC (1), XSLT (1).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-159/jaldhar-h-vyas/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-159/jaldhar-h-vyas/perl/ch-2.pl)]
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-159/jaldhar-h-vyas/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-159/jaldhar-h-vyas/raku/ch-2.raku)]
[[**BLOG #1**](https://www.braincells.com/perl/2022/04/perl_weekly_challenge_week_159.html)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-159/robert-dicicco/perl/ch-1.pl)]
