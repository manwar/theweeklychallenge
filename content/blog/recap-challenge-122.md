...
#### 1. Abigail (656)
    Awk (68), Bash (59), Basic (9), Bc (16), Befunge (21), Brainfuck (1), C (72), C Shell (6), COBOL (6), Chef (1), Erlang (5), Forth (6), Fortran (8), Go (15), Java (14), Lua (58), M4 (1), MMIX (2), Macro Processor (4), Mumps (1), Node.js (77), OCaml (5), Ook (1), PHP (5), Pascal (17), Postscript (4), Python (62), R (13), Rexx (5), Ruby (58), SQL (10), Scheme (11), Sed (5), Tcl (10).
#### 2. Stuart Little (388)
