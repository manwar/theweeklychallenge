...
#### 12. PokGoPun (76)
    Go (76).
#### 13. Conor Hoekstra (74)
    APL (48), BQN (13), C++ (1), Haskell (5), J (7).
#### 14. Richard Park (73)
    APL (68), BQN (1), JavaScript (2), Python (2).
#### 15. Cheok-Yin Fung (68)
    Awk (3), Bash (6), Befunge-93 (1), C++ (1), Dart (4), Java (14), JavaScript (1), Julia (12), Lisp (11), Node.js (2), Python (4), Smalltalk (9).
#### 16. Luca Ferrari (57)
    PostgreSQL (57).
#### 17. Mohammad Meraj Zia (53)
    Java (45), Kotlin (8).
#### 18. Robert DiCicco (51)
    Bash (1), Julia (15), Python (4), Ruby (25), Tcl (6).
#### 19. Mohammad S Anwar (49)
    Java (9), Python (15), Swift (25).
#### 20. Ali Moradi (48)
    C (6), C++ (10), D (4), Haskell (2), Lua (12), Oberon (2), Pascal (12).
#### 21. Nuno Vieira (44)
    JavaScript (44).
#### 22. Walt Mankowski (39)
    C (6), C++ (4), Python (29).
#### 23. Simon Green (37)
    Python (37).
#### 24. Andrew Shitov (34)
...
#### 30. Alexander Pankoff (19)
    Haskell (19).
#### 31. Dave Jacoby (18)
    HTML (1), Node.js (14), Python (1), Rust (2).
#### 32. Duncan C. White (17)
...
#### 51. Henry Wong (6)
    PHP (6).
#### 52. Michael DiCicco (6)
    Java (3), Python (3).
#### 53. Arne Sommer (5)
    Bash (1), Node.js (1), PHP (1), Python (1), Ruby (1).
#### 54. Bartosz Jarzyna (4)
    C (1), PHP (2), Pascal (1).
#### 55. Ben Davies (4)
    Idris (2), Scala (2).
