...
#### 1. Abigail (889)
    Awk (91), Bash (76), Basic (10), Bc (25), Befunge (23), Brainfuck (1), C (93), C Shell (8), COBOL (7), Chef (1), Erlang (8), Forth (7), Fortran (9), Go (27), Java (26), Lua (78), M4 (3), MMIX (3), Macro Processor (4), Mumps (1), Node.js (97), OCaml (6), Ook (1), PHP (7), Pascal (27), Postscript (5), Python (82), R (21), Rexx (6), Ruby (76), SQL (11), Scheme (22), Sed (5), Tcl (22).
#### 2. Stuart Little (436)
    Haskell (256), Lua (88), Node.js (44), Python (48).
#### 3. Paulo Custodio (428)
    Ada (19), Adb (1), Awk (27), Basic (43), Bc (16), Brainfuck (4), C (57), C++ (56), D (13), Forth (41), Fortran (7), Lua (37), Pascal (5), Python (102).
#### 4. Roger Bell_West (351)
    Bash (1), Postscript (23), Python (121), Ruby (109), Rust (97).
#### 5. Ulrich Rieke (185)
    Awk (1), C (2), C++ (78), Haskell (95), Java (2), Lisp (7).
#### 6. Tyler Wardhaugh (162)
...
#### 12. Cheok-Yin Fung (46)
    Awk (2), Bash (5), Java (11), Julia (5), Lisp (11), Node.js (1), Python (3), Smalltalk (8).
#### 13. Mohammad Meraj Zia (46)
    Java (38), Kotlin (8).
#### 14. Nuno Vieira (44)
    JavaScript (44).
#### 15. Conor Hoekstra (39)
    APL (21), BQN (8), C++ (1), Haskell (4), J (5).
#### 16. Eric Cheung (38)
