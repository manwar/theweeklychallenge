...
#### 1. Abigail (1083)
    Awk (102), Bash (88), Basic (11), Bc (38), Befunge (24), Brainfuck (1), C (104), C Shell (9), COBOL (7), Chef (1), Cobol (1), Erlang (9), Forth (8), Fortran (10), Go (41), Java (38), Lua (90), M4 (4), MMIX (4), Macro Processor (4), Mumps (1), Node.js (109), OCaml (7), Ook (1), PHP (8), Pascal (41), Postscript (6), Python (94), R (37), Rexx (7), Ruby (88), SQL (12), Scheme (35), Sed (6), Tcl (37).
...
#### 13. Cheok-Yin Fung (50)
    Awk (2), Bash (5), Befunge (1), Java (12), JavaScript (1), Julia (6), Lisp (11), Node.js (1), Python (3), Smalltalk (8).
#### 14. Mohammad Meraj Zia (50)
    Java (42), Kotlin (8).
#### 15. Conor Hoekstra (47)
    APL (28), BQN (9), C++ (1), Haskell (4), J (5).
#### 16. Nuno Vieira (44)
    JavaScript (44).
#### 17. Mohammad S Anwar (39)
