...
#### 5. Ali Moradi (447)
    Ada (14), C (39), C++ (47), D (44), Go (4), Haskell (4), Java (4), Lisp (14), Lua (62), Modula 3 (42), Nelua (12), Nim (24), OCaml (4), Oberon (33), Pascal (56), Python (32), Ruby (12).
#### 6. Stuart Little (436)
...
#### 8. Lubos Kolouch (394)
    Bash (6), C++ (1), Go (2), Java (18), JavaScript (1), PHP (9), Python (355), Ruby (1), VBA (1).
...
#### 28. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 29. Steven Wilson (41)
    Haskell (1), JavaScript (13), Python (26), Rust (1).
#### 30. Andrew Shitov (34)
...
#### 60. Shawak (8)
    Ruby (8).
#### 61. Andrew Grangaard (6)
    Python (4), Rust (2).
#### 62. Henry Wong (6)
    PHP (6).
#### 63. Joao Felipe (6)
    APL (4), Python (2).
#### 64. Michael DiCicco (6)
    Java (3), Python (3).
#### 65. W. Luis Mochan (6)
...
#### 82. Gabor Szabo (3)
    Crystal (3).
#### 83. Guillermo Ramos (3)
    Go (3).
#### 84. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 85. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 86. Rage311 (3)
    Rust (3).
#### 87. Carlos Oliveira (2)
    C (2).
#### 88. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 89. Humberto Massa (2)
