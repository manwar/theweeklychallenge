...
#### 1. Roger Bell_West (1640)
    Bash (1), JavaScript (172), Kotlin (177), Lua (168), Postscript (213), Python (312), Ruby (300), Rust (291), Scala (6).
#### 2. Abigail (1540)
...
#### 3. Paulo Custodio (978)
    Ada (21), Awk (28), BASIC (76), Bc (17), Brainfuck (5), C (240), C++ (89), D (14), Forth (74), Fortran (8), Lua (38), Pascal (6), Python (362).
#### 4. Ulrich Rieke (594)
    Awk (3), C (2), C++ (221), Haskell (257), Java (9), Julia (1), Lisp (7), Python (1), Ruby (1), Rust (92).
#### 5. Lubos Kolouch (530)
    Bash (6), C++ (1), Go (5), Java (40), JavaScript (1), Kotlin (2), PHP (9), Python (464), Ruby (1), VBA (1).
#### 6. Ali Moradi (465)
...
#### 9. Robert DiCicco (326)
    BASIC (2), Bash (1), Go (2), Julia (106), Lua (2), PowerShell (6), Python (65), Ruby (119), Rust (1), Tcl (22).
#### 10. AhmetEmre (282)
    BQN (281), Javascript (1).
#### 11. Tyler Wardhaugh (260)
    Clojure (200), Fennel (8), Lua (36), Python (16).
#### 12. Eric Cheung (234)
    Excel VBA (63), Python (171).
#### 13. Adam Russell (176)
    C++ (26), Fortran (3), Java (16), Nuweb (3), Prolog (128).
#### 14. PokGoPun (166)
    Dart (24), Go (124), Python (18).
#### 15. Luca Ferrari (159)
    PostgreSQL (159).
#### 16. Simon Green (145)
    Python (145).
...
#### 30. Walt Mankowski (43)
    C (8), C++ (4), Python (31).
#### 31. Steven Wilson (42)
    Haskell (1), JavaScript (13), Python (27), Rust (1).
#### 32. Andrew Shitov (34)
...
#### 57. Asher Harvey-Smith (8)
    APL (2), BQN (2), Haskell (2), J (2).
#### 58. Aviral Goel (8)
    Haskell (8).
#### 59. Burkhard Nickels (8)
    Python (8).
#### 60. Sangeet Kar (8)
    Python (8).
#### 61. Shawak (8)
...
#### 83. Andinus (3)
    C (3).
#### 84. Andrii Mishchenko (3)
    Ruby (3).
#### 85. Gabor Szabo (3)
    Crystal (3).
#### 86. Guillermo Ramos (3)
    Go (3).
#### 87. Jorg Sommrey (3)
    Maxima (1), Octave (2).
#### 88. Mohammad Khalid Anwar (3)
    C++ (1), PHP (1), Python (1).
#### 89. Rage311 (3)
    Rust (3).
#### 90. Carlos Oliveira (2)
    C (2).
#### 91. Daniel Mita (2)
    Go (1), JavaScript (1).
#### 92. Humberto Massa (2)
...
#### 101. Bob Lied (1)
    C (1).
#### 102. Christian Jaeger (1)
    Haskell (1).
#### 103. Daniel Aberger (1)
    Go (1).
#### 104. Darren Bottin (1)
    Prolog (1).
#### 105. David Schwartz (1)
    Python (1).
#### 106. Gurunandan Bhat (1)
    Go (1).
#### 107. Jaldhar H. Vyas (1)
    C++ (1).
#### 108. Maxim Kolodyazhny (1)
    Elixir (1).
#### 109. Robbie Hatley (1)
    C (1).
#### 110. Roman Kotelnikov (1)
    J (1).
#### 111. Stephen G. Lynn (1)
    Julia (1).
...
***
    ...
    Python (2137), Ruby (605), Haskell (592), C (583), Lua (526), Rust (468), C++ (413), BQN (315), JavaScript (299), Go (285), Java (273), Postscript (232), Kotlin (230), Julia (229), Clojure (200), Node.js (196), Awk (190), PostgreSQL (159), Nim (148), Pascal (147), APL (137), Prolog (135), Bash (132), BASIC (100), Tcl (99), Forth (92), Bc (84), D (80), Scala (78), R (75), Excel VBA (63), Lisp (59), Scheme (58), Modula 3 (44), PHP (41), Swift (41), Dart (40), Ada (35), Befunge-93 (35), Oberon (35), Fortran (33), OCaml (29), SQL (23), Erlang (22), Ring (20), C Shell (19), COBOL (18), M4 (18), Rexx (17), Sed (16), Elm (15), MMIX (14), F# (12), Nelua (12), J (11), Smalltalk (9), Fennel (8), PowerShell (8), Brainfuck (6), Emacs Lisp (4), Racket (4), TypeScript (4), CESIL (3), Coconut (3), Crystal (3), Gembase (3), Janet (3), Nuweb (3), Octave (3), Zig (3), C3 (2), Dc (2), GP (2), HTML (2), Haxe (2), Idris (2), Korn Shell (2), Miranda (2), Myrddin (2), Nix (2), Odin (2), WebAssembly (2), Wolfram (2), YaBasic (2), Bourne Shell (1), C# (1), Chef (1), Elixir (1), Fish (1), GNAT (1), IO (1), Javascript (1), Logo (1), Maxima (1), Mumps (1), Node (1), Ook (1), SVG (1), V (1), VBA (1), Visual BASIC (1), XSLT (1).
...
***
    ...
    Laurent Rosenfeld (2346), Jaldhar H. Vyas (2210), Roger Bell_West (2112), Luca Ferrari (1868), Arne Sommer (1714), Flavio Poletti (1692), Athanasius (1462), Colin Crain (1336), Ulrich Rieke (1314), Adam Russell (1114), Dave Jacoby (1066), E. Choroba (1036), Lubos Kolouch (1006), Paulo Custodio (944), Jorg Sommrey (892), W. Luis Mochan (880), James Smith (860), Simon Green (796), Duncan C. White (794), Cheok-Yin Fung (744), Mark Anderson (744), Mohammad Sajid Anwar (718), Stuart Little (644), Peter Campbell Smith (592), Abigail (574), Feng Chang (574), Jan Krnavek (566), Robert DiCicco (544), Simon Proctor (540), Niels van Dijke (518), Bruce Gray (484), Javier Luque (460), Ruben Westerberg (452), Bob Lied (416), Stephen G. Lynn (400), Ryan Thompson (390), Wanderdoc (378), Pete Houston (360), Thomas Kohler (338), Robert Ransbottom (326), Ali Moradi (326), Matthew Neleigh (320), Joelle Maslak (278), Robbie Hatley (276), David Ferrone (266), Andrezgz (252), Steven Wilson (242), Yet Ebreo (222), Alexander Pankoff (220), Peter Meszaros (220), Andrew Shitov (216), Markus Holzer (198), Walt Mankowski (196), Myoungjin Jeon (192), Noud Aldenhoven (188), Matthias Muth (186), Reinier Maliepaard (180), Marton Polgar (178), Avery Adams (176), Kevin Colyer (176), Solathian (176), Aaron Smith (174), Duane Powell (164), BarrOff (162), Kian-Meng Ang (162), Mark Senn (156), Dave Cross (140), Shahed Nooshmand (140), Andinus (132), Pip Stuart (132), Cristina Heredia (126), Joan Mimosinnet (120), Kang-min Liu (118), Julio de Castro (116), Saif Ahmed (114), Gustavo Chaves (112), Packy Anderson (110), Alicia Bielsa (106), Burkhard Nickels (106), Nuno Vieira (104).
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/zapwai/perl/ch-1.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/kjetillll/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/kjetillll/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/paulo-custodio/perl/ch-1.pl)]
[[**PERL #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/paulo-custodio/perl/ch-2.pl)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/peter-campbell-smith/perl/ch-1.pl)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/bruce-gray/raku/ch-1.raku)]
...
[[**RAKU #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/feng-chang/raku/ch-1.raku)]
[[**RAKU #2**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/feng-chang/raku/ch-2.raku)]
...
[[**PERL #1**](https://github.com/manwar/perlweeklychallenge-club/blob/master/challenge-237/robert-dicicco/perl/ch-1.pl)]
